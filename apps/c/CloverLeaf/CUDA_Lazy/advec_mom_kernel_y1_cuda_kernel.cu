...
void ops_par_loop_advec_mom_kernel_y1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_y1_h || xdim1 != xdim1_advec_mom_kernel_y1_h || xdim2 != xdim2_advec_mom_kernel_y1_h || xdim3 != xdim3_advec_mom_kernel_y1_h || xdim4 != xdim4_advec_mom_kernel_y1_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel_y1, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_mom_kernel_y1_h = xdim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel_y1, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_mom_kernel_y1_h = xdim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel_y1, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_mom_kernel_y1_h = xdim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel_y1, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_mom_kernel_y1_h = xdim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_mom_kernel_y1, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel_y1<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
