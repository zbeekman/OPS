...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_4_a_h || xdim1 != xdim1_update_halo_kernel2_yvel_plus_4_a_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_yvel_plus_4_a, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_yvel_plus_4_a_h = xdim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_yvel_plus_4_a, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_yvel_plus_4_a<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
