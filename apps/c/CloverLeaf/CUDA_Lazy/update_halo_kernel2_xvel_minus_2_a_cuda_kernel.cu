...
inline void update_halo_kernel2_xvel_minus_2_a_gpu(double *xvel0, double *xvel1, const int* fields)
{
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel2_xvel_minus_2_a;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel2_xvel_minus_2_a;
...
void ops_par_loop_update_halo_kernel2_xvel_minus_2_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_minus_2_a_h || xdim1 != xdim1_update_halo_kernel2_xvel_minus_2_a_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_xvel_minus_2_a, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_xvel_minus_2_a_h = xdim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_xvel_minus_2_a, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_xvel_minus_2_a<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
