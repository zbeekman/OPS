...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_flux_calc_kernelx;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_flux_calc_kernelx;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_flux_calc_kernelx;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_flux_calc_kernelx;
