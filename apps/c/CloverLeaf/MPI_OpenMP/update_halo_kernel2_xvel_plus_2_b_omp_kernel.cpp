...
inline void update_halo_kernel2_xvel_plus_2_b(double *xvel0, double *xvel1,
                                              const int *fields) {
...
#pragma simd
        for (int i = 0; i < SIMD_VEC; i++) {
          update_halo_kernel2_xvel_plus_2_b((double *)p_a[0] + i * 1 * 1,
                                            (double *)p_a[1] + i * 1 * 1,
                                            (int *)p_a[2]);
        }
      ...
      for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
        ...
        update_halo_kernel2_xvel_plus_2_b((double *)p_a[0], (double *)p_a[1],
                                          (int *)p_a[2]);
