...
// user function
inline void update_halo_kernel2_xvel_minus_4_b(__global double *restrict xvel0,
  ...
  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel2_xvel_minus_4_b(
        &arg0[base0 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim0_update_halo_kernel2_xvel_minus_4_b],
        &arg1[base1 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim1_update_halo_kernel2_xvel_minus_4_b],
        &arg2);
  }
}
