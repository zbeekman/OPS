...
void buildOpenCLKernels_update_halo_kernel3_minus_2_a(int xdim0, int xdim1) {
  ...
  if (!isbuilt_update_halo_kernel3_minus_2_a) {
    ...
    OPS_opencl_core.kernel[72] = clCreateKernel(
...
void ops_par_loop_update_halo_kernel3_minus_2_a(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel3_minus_2_a(xdim0, xdim1);
