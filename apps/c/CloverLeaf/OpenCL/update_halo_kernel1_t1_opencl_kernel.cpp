...
void buildOpenCLKernels_update_halo_kernel1_t1(int xdim0, int xdim1, int xdim2,
  ...
  if (!isbuilt_update_halo_kernel1_t1) {
    ...
    printf("Compiling update_halo_kernel1_t1 %d source -- start \n", OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_update_halo_kernel1_t1=%d  "
                           "-Dxdim1_update_halo_kernel1_t1=%d  "
                           "-Dxdim2_update_halo_kernel1_t1=%d  "
                           "-Dxdim3_update_halo_kernel1_t1=%d  "
                           "-Dxdim4_update_halo_kernel1_t1=%d  "
                           "-Dxdim5_update_halo_kernel1_t1=%d  "
                           "-Dxdim6_update_halo_kernel1_t1=%d ",
    ...
    OPS_opencl_core.kernel[46] = clCreateKernel(
        OPS_opencl_core.program, "ops_update_halo_kernel1_t1", &ret);
    clSafeCall(ret);
...
void ops_par_loop_update_halo_kernel1_t1(char const *name, ops_block block,
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 8, range, 46))
    return;
#endif
  ...
  buildOpenCLKernels_update_halo_kernel1_t1(xdim0, xdim1, xdim2, xdim3, xdim4,
                                            xdim5, xdim6);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 0, sizeof(cl_mem),
                            (void *)&arg0.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 2, sizeof(cl_mem),
                            (void *)&arg2.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 7, sizeof(cl_int),
                            (void *)arg7.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 8, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 9, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 10, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 11, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 12, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 13, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 14, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 15, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[46], 16, sizeof(cl_int),
                            (void *)&y_size));

  // call/enque opencl kernel wrapper function
  clSafeCall(clEnqueueNDRangeKernel(
      OPS_opencl_core.command_queue, OPS_opencl_core.kernel[46], 3, NULL,
