...
void buildOpenCLKernels_update_halo_kernel2_yvel_minus_4_a(int xdim0,
  ...
  if (!isbuilt_update_halo_kernel2_yvel_minus_4_a) {
    ...
    printf("Compiling update_halo_kernel2_yvel_minus_4_a %d source -- start \n",
           OCL_FMA);
...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_a(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel2_yvel_minus_4_a(xdim0, xdim1);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[59], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[59], 2, sizeof(cl_int),
                            (void *)arg2.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[59], 3, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[59], 4, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[59], 5, sizeof(cl_int),
                            (void *)&x_size));
