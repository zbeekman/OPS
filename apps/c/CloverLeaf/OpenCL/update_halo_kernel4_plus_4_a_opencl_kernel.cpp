...
void buildOpenCLKernels_update_halo_kernel4_plus_4_a(int xdim0, int xdim1) {
  ...
  if (!isbuilt_update_halo_kernel4_plus_4_a) {
    ...
    OPS_opencl_core.kernel[79] = clCreateKernel(
...
void ops_par_loop_update_halo_kernel4_plus_4_a(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel4_plus_4_a(xdim0, xdim1);
