...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_a(int xdim0,
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_2_a) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/update_halo_kernel2_yvel_plus_2_a.cl"};
    ...
    printf("Compiling update_halo_kernel2_yvel_plus_2_a %d source -- start \n",
           OCL_FMA);
    ...
    OPS_opencl_core.kernel[64] = clCreateKernel(
        OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_plus_2_a", &ret);
    clSafeCall(ret);
...
// host stub function
void ops_par_loop_update_halo_kernel2_yvel_plus_2_a(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_a(xdim0, xdim1);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 2, sizeof(cl_int),
                            (void *)arg2.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 3, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 4, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 5, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 6, sizeof(cl_int),
                            (void *)&y_size));
