...
void buildOpenCLKernels_update_halo_kernel4_plus_2_b(int xdim0, int xdim1) {
  ...
  if (!isbuilt_update_halo_kernel4_plus_2_b) {
    ...
    OPS_opencl_core.kernel[82] = clCreateKernel(
...
void ops_par_loop_update_halo_kernel4_plus_2_b(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel4_plus_2_b(xdim0, xdim1);
