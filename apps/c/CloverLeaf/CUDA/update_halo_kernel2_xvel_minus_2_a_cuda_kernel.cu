...
__device__
    ...
    inline void
    update_halo_kernel2_xvel_minus_2_a_gpu(double *xvel0, double *xvel1,
                                           const int *fields) {
...
__global__ void ops_update_halo_kernel2_xvel_minus_2_a(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel2_xvel_minus_2_a;
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel2_xvel_minus_2_a;

  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel2_xvel_minus_2_a_gpu(arg0, arg1, &arg2);
  }
}
...
void ops_par_loop_update_halo_kernel2_xvel_minus_2_a(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_minus_2_a_h ||
      xdim1 != xdim1_update_halo_kernel2_xvel_minus_2_a_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_xvel_minus_2_a, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_xvel_minus_2_a_h = xdim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_xvel_minus_2_a, &xdim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_xvel_minus_2_a<<<grid, tblock>>>(
