...
__device__
    ...
    inline void
    update_halo_kernel2_yvel_plus_2_b_gpu(double *yvel0, double *yvel1,
                                          const int *fields) {
...
__global__ void ops_update_halo_kernel2_yvel_plus_2_b(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel2_yvel_plus_2_b;
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel2_yvel_plus_2_b;
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_b(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_2_b_h ||
      xdim1 != xdim1_update_halo_kernel2_yvel_plus_2_b_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_yvel_plus_2_b, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_yvel_plus_2_b_h = xdim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_yvel_plus_2_b, &xdim1,
                       sizeof(int));
