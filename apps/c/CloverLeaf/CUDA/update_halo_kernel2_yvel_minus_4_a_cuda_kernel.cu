...
__global__ void ops_update_halo_kernel2_yvel_minus_4_a(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel2_yvel_minus_4_a;
  arg1 +=
...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_a(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_minus_4_a_h ||
    ...
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_yvel_minus_4_a, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_yvel_minus_4_a_h = xdim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_yvel_minus_4_a, &xdim1,
                       sizeof(int));
