...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_advec_mom_kernel_y1*1+x+xdim0_advec_mom_kernel_y1*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_advec_mom_kernel_y1*1+x+xdim1_advec_mom_kernel_y1*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_advec_mom_kernel_y1*1+x+xdim2_advec_mom_kernel_y1*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_advec_mom_kernel_y1*1+x+xdim3_advec_mom_kernel_y1*(y))
#define OPS_ACC4(x,y) (n_x*1+n_y*xdim4_advec_mom_kernel_y1*1+x+xdim4_advec_mom_kernel_y1*(y))
...
void ops_par_loop_advec_mom_kernel_y1_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_advec_mom_kernel_y1 = args[0].dat->size[0];
  int xdim1_advec_mom_kernel_y1 = args[1].dat->size[0];
  int xdim2_advec_mom_kernel_y1 = args[2].dat->size[0];
  int xdim3_advec_mom_kernel_y1 = args[3].dat->size[0];
  int xdim4_advec_mom_kernel_y1 = args[4].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(pre_vol,post_vol,volume,vol_flux_x,vol_flux_y)
    #else
    #pragma simd
    #endif
