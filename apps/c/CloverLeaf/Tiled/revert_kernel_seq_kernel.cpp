...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_revert_kernel*1+x+xdim0_revert_kernel*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_revert_kernel*1+x+xdim1_revert_kernel*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_revert_kernel*1+x+xdim2_revert_kernel*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_revert_kernel*1+x+xdim3_revert_kernel*(y))
