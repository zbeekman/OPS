...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_advec_cell_kernel4_xdir*1+x+xdim0_advec_cell_kernel4_xdir*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_advec_cell_kernel4_xdir*1+x+xdim1_advec_cell_kernel4_xdir*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_advec_cell_kernel4_xdir*1+x+xdim2_advec_cell_kernel4_xdir*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_advec_cell_kernel4_xdir*1+x+xdim3_advec_cell_kernel4_xdir*(y))
#define OPS_ACC4(x,y) (n_x*1+n_y*xdim4_advec_cell_kernel4_xdir*1+x+xdim4_advec_cell_kernel4_xdir*(y))
#define OPS_ACC5(x,y) (n_x*1+n_y*xdim5_advec_cell_kernel4_xdir*1+x+xdim5_advec_cell_kernel4_xdir*(y))
#define OPS_ACC6(x,y) (n_x*1+n_y*xdim6_advec_cell_kernel4_xdir*1+x+xdim6_advec_cell_kernel4_xdir*(y))
#define OPS_ACC7(x,y) (n_x*1+n_y*xdim7_advec_cell_kernel4_xdir*1+x+xdim7_advec_cell_kernel4_xdir*(y))
#define OPS_ACC8(x,y) (n_x*1+n_y*xdim8_advec_cell_kernel4_xdir*1+x+xdim8_advec_cell_kernel4_xdir*(y))
#define OPS_ACC9(x,y) (n_x*1+n_y*xdim9_advec_cell_kernel4_xdir*1+x+xdim9_advec_cell_kernel4_xdir*(y))
#define OPS_ACC10(x,y) (n_x*1+n_y*xdim10_advec_cell_kernel4_xdir*1+x+xdim10_advec_cell_kernel4_xdir*(y))
