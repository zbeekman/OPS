...
//
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 + n_y * xdim0_update_halo_kernel2_yvel_minus_2_a * 1 + x +          \
   xdim0_update_halo_kernel2_yvel_minus_2_a * (y))
#define OPS_ACC1(x, y)                                                         \
  (n_x * 1 + n_y * xdim1_update_halo_kernel2_yvel_minus_2_a * 1 + x +          \
   xdim1_update_halo_kernel2_yvel_minus_2_a * (y))

// user function

// host stub function
void ops_par_loop_update_halo_kernel2_yvel_minus_2_a_execute(
  ...
  int xdim0_update_halo_kernel2_yvel_minus_2_a = args[0].dat->size[0];
  int xdim1_update_halo_kernel2_yvel_minus_2_a = args[1].dat->size[0];
