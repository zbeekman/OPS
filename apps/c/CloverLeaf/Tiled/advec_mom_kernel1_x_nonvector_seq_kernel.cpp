...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_advec_mom_kernel1_x_nonvector*1+x+xdim0_advec_mom_kernel1_x_nonvector*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_advec_mom_kernel1_x_nonvector*1+x+xdim1_advec_mom_kernel1_x_nonvector*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_advec_mom_kernel1_x_nonvector*1+x+xdim2_advec_mom_kernel1_x_nonvector*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_advec_mom_kernel1_x_nonvector*0+x+xdim3_advec_mom_kernel1_x_nonvector*(y))
#define OPS_ACC4(x,y) (n_x*1+n_y*xdim4_advec_mom_kernel1_x_nonvector*1+x+xdim4_advec_mom_kernel1_x_nonvector*(y))
