...
// reduction variables
double p_a6_0_field_summary_kernel = 0;
double p_a7_0_field_summary_kernel = 0;
double p_a8_0_field_summary_kernel = 0;
double p_a9_0_field_summary_kernel = 0;
double p_a10_0_field_summary_kernel = 0;
...
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #endif
  #ifdef OPS_PARREGION
  #pragma omp for reduction(+:p_a6_0_field_summary_kernel) reduction(+:p_a7_0_field_summary_kernel) reduction(+:p_a8_0_field_summary_kernel) reduction(+:p_a9_0_field_summary_kernel) reduction(+:p_a10_0_field_summary_kernel)
  #else
  #pragma omp parallel for reduction(+:p_a6_0_field_summary_kernel) reduction(+:p_a7_0_field_summary_kernel) reduction(+:p_a8_0_field_summary_kernel) reduction(+:p_a9_0_field_summary_kernel) reduction(+:p_a10_0_field_summary_kernel)
  #endif
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    #ifdef intel
    #pragma loop_count(10000)
    #pragma omp simd reduction(+:p_a6_0_field_summary_kernel) reduction(+:p_a7_0_field_summary_kernel) reduction(+:p_a8_0_field_summary_kernel) reduction(+:p_a9_0_field_summary_kernel) reduction(+:p_a10_0_field_summary_kernel) aligned(volume,density0,energy0,pressure,xvel0,yvel0)
    #else
    #pragma omp simd reduction(+:p_a6_0_field_summary_kernel) reduction(+:p_a7_0_field_summary_kernel) reduction(+:p_a8_0_field_summary_kernel) reduction(+:p_a9_0_field_summary_kernel) reduction(+:p_a10_0_field_summary_kernel)
    #endif
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      double *vol = &p_a6_0_field_summary_kernel;
      double *mass = &p_a7_0_field_summary_kernel;
      double *ie = &p_a8_0_field_summary_kernel;
      double *ke = &p_a9_0_field_summary_kernel;
      double *press = &p_a10_0_field_summary_kernel;
  ...
  *press = *press + cell_vol * pressure[OPS_ACC3(0,0)];
  ...
  {
  #endif
  p_a6[0] += p_a6_0_field_summary_kernel;
  p_a6_0_field_summary_kernel = 0;
  p_a7[0] += p_a7_0_field_summary_kernel;
  p_a7_0_field_summary_kernel = 0;
  p_a8[0] += p_a8_0_field_summary_kernel;
  p_a8_0_field_summary_kernel = 0;
  p_a9[0] += p_a9_0_field_summary_kernel;
  p_a9_0_field_summary_kernel = 0;
  p_a10[0] += p_a10_0_field_summary_kernel;
  p_a10_0_field_summary_kernel = 0;
  #ifdef OPS_PARREGION
  }
  #endif
}
