...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_update_halo_kernel4_minus_4_a*1+x+xdim0_update_halo_kernel4_minus_4_a*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_update_halo_kernel4_minus_4_a*1+x+xdim1_update_halo_kernel4_minus_4_a*(y))
