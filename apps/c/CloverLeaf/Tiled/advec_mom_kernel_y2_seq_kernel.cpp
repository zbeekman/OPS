...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_advec_mom_kernel_y2*1+x+xdim0_advec_mom_kernel_y2*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_advec_mom_kernel_y2*1+x+xdim1_advec_mom_kernel_y2*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_advec_mom_kernel_y2*1+x+xdim2_advec_mom_kernel_y2*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_advec_mom_kernel_y2*1+x+xdim3_advec_mom_kernel_y2*(y))
