...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_flux_calc_kernelx*1+x+xdim0_flux_calc_kernelx*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_flux_calc_kernelx*1+x+xdim1_flux_calc_kernelx*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_flux_calc_kernelx*1+x+xdim2_flux_calc_kernelx*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_flux_calc_kernelx*1+x+xdim3_flux_calc_kernelx*(y))
