...
__constant__ int xdim4_taylor_green_vortex_block0_18_kernel;
int xdim4_taylor_green_vortex_block0_18_kernel_h = -1;
__constant__ int ydim4_taylor_green_vortex_block0_18_kernel;
int ydim4_taylor_green_vortex_block0_18_kernel_h = -1;
...
#define OPS_ACC4(x,y,z) (x+xdim4_taylor_green_vortex_block0_18_kernel*(y)+xdim4_taylor_green_vortex_block0_18_kernel*ydim4_taylor_green_vortex_block0_18_kernel*(z))

//user function
__device__

void taylor_green_vortex_block0_18_kernel_gpu(double *rhou1 , double *rhoE , double *rho , double *rhou2 , double *rhou0)
{
...
int size2 ){
  ...
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_taylor_green_vortex_block0_18_kernel + idx_z * 1*1 * xdim4_taylor_green_vortex_block0_18_kernel * ydim4_taylor_green_vortex_block0_18_kernel;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    taylor_green_vortex_block0_18_kernel_gpu(arg0, arg1, arg2, arg3,
                   arg4);
  }
...
// host stub function
// host stub function
void ops_par_loop_taylor_green_vortex_block0_18_kernel_execute(ops_kernel_descriptor *desc) {
  #ifdef OPS_MPI
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(4,"taylor_green_vortex_block0_18_kernel");
    OPS_kernels[4].count++;
  ...
  if (xdim0 != xdim0_taylor_green_vortex_block0_18_kernel_h || ydim0 != ydim0_taylor_green_vortex_block0_18_kernel_h || xdim1 != xdim1_taylor_green_vortex_block0_18_kernel_h || ydim1 != ydim1_taylor_green_vortex_block0_18_kernel_h || xdim2 != xdim2_taylor_green_vortex_block0_18_kernel_h || ydim2 != ydim2_taylor_green_vortex_block0_18_kernel_h || xdim3 != xdim3_taylor_green_vortex_block0_18_kernel_h || ydim3 != ydim3_taylor_green_vortex_block0_18_kernel_h || xdim4 != xdim4_taylor_green_vortex_block0_18_kernel_h || ydim4 != ydim4_taylor_green_vortex_block0_18_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_taylor_green_vortex_block0_18_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_taylor_green_vortex_block0_18_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_taylor_green_vortex_block0_18_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_taylor_green_vortex_block0_18_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_taylor_green_vortex_block0_18_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_taylor_green_vortex_block0_18_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_taylor_green_vortex_block0_18_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_taylor_green_vortex_block0_18_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_taylor_green_vortex_block0_18_kernel, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_taylor_green_vortex_block0_18_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_taylor_green_vortex_block0_18_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_taylor_green_vortex_block0_18_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_taylor_green_vortex_block0_18_kernel, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_taylor_green_vortex_block0_18_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_taylor_green_vortex_block0_18_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_taylor_green_vortex_block0_18_kernel_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_taylor_green_vortex_block0_18_kernel, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_taylor_green_vortex_block0_18_kernel_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_taylor_green_vortex_block0_18_kernel, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_taylor_green_vortex_block0_18_kernel_h = ydim4;
  }
  ...
  ops_taylor_green_vortex_block0_18_kernel<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
...
void ops_par_loop_taylor_green_vortex_block0_18_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4) {
  ...
  desc->function = ops_par_loop_taylor_green_vortex_block0_18_kernel_execute;
  if (OPS_diags > 1) {
    ops_timing_realloc(4,"taylor_green_vortex_block0_18_kernel");
  }
