...
// host stub function
// host stub function
void ops_par_loop_taylor_green_vortex_block0_9_kernel_execute(ops_kernel_descriptor *desc) {
  #ifdef OPS_MPI
  ...
  if (xdim0 != xdim0_taylor_green_vortex_block0_9_kernel_h || ydim0 != ydim0_taylor_green_vortex_block0_9_kernel_h || xdim1 != xdim1_taylor_green_vortex_block0_9_kernel_h || ydim1 != ydim1_taylor_green_vortex_block0_9_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_taylor_green_vortex_block0_9_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_taylor_green_vortex_block0_9_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_taylor_green_vortex_block0_9_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_taylor_green_vortex_block0_9_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_taylor_green_vortex_block0_9_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_taylor_green_vortex_block0_9_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_taylor_green_vortex_block0_9_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_taylor_green_vortex_block0_9_kernel<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
...
void ops_par_loop_taylor_green_vortex_block0_9_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->function = ops_par_loop_taylor_green_vortex_block0_9_kernel_execute;
  if (OPS_diags > 1) {
    ops_timing_realloc(17,"taylor_green_vortex_block0_9_kernel");
  }
