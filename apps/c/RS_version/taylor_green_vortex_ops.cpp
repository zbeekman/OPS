...
void ops_par_loop_taylor_green_vortex_block0_19_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_taylor_green_vortex_block0_20_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_taylor_green_vortex_block0_1_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg );

void ops_par_loop_taylor_green_vortex_block0_2_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg );
...
int main (int argc, char **argv)
{
   ...
   ops_init(argc,argv,1);
    ...
    ops_decl_const2( "rinv8",1, "double",&rinv8);
    ...
    ops_decl_const2( "rc10",1, "double",&rc10);
    ops_decl_const2( "deltai0",1, "double",&deltai0);
    ops_decl_const2( "Re",1, "double",&Re);
    ops_decl_const2( "rinv7",1, "double",&rinv7);
    ops_decl_const2( "gama",1, "double",&gama);
    ops_decl_const2( "rc11",1, "double",&rc11);
  ...
  ops_diagnostic_output();
   ...
   ops_par_loop_taylor_green_vortex_block0_14_kernel("Initialisation", taylor_green_vortex_block, 3, iter_range14,
   ...
   ops_par_loop_taylor_green_vortex_block0_15_kernel("Symmetry bc 0 Left", taylor_green_vortex_block, 3, iter_range15,
   ...
   ops_par_loop_taylor_green_vortex_block0_16_kernel("Symmetry bc 0 Right", taylor_green_vortex_block, 3, iter_range16,
                ops_arg_dat(rhou1, 1, stencil3, "double", OPS_RW),
                ops_arg_dat(rhoE, 1, stencil3, "double", OPS_RW),
                ops_arg_dat(rho, 1, stencil3, "double", OPS_RW),
                ops_arg_dat(rhou2, 1, stencil3, "double", OPS_RW),
   ...
   ops_par_loop_taylor_green_vortex_block0_17_kernel("Symmetry bc 1 Left", taylor_green_vortex_block, 3, iter_range17,
   ...
   ops_par_loop_taylor_green_vortex_block0_18_kernel("Symmetry bc 1 Right", taylor_green_vortex_block, 3, iter_range18,
                ops_arg_dat(rhou1, 1, stencil2, "double", OPS_RW),
                ops_arg_dat(rhoE, 1, stencil2, "double", OPS_RW),
                ops_arg_dat(rho, 1, stencil2, "double", OPS_RW),
                ops_arg_dat(rhou2, 1, stencil2, "double", OPS_RW),
   ...
   ops_par_loop_taylor_green_vortex_block0_19_kernel("Symmetry bc 2 Left", taylor_green_vortex_block, 3, iter_range19,
   ...
   ops_par_loop_taylor_green_vortex_block0_20_kernel("Symmetry bc 2 Right", taylor_green_vortex_block, 3, iter_range20,
                ops_arg_dat(rhou1, 1, stencil1, "double", OPS_RW),
                ops_arg_dat(rhoE, 1, stencil1, "double", OPS_RW),
                ops_arg_dat(rho, 1, stencil1, "double", OPS_RW),
                ops_arg_dat(rhou2, 1, stencil1, "double", OPS_RW),
   ...
   for (int iteration=0; iteration<30; iteration++){
      ...
      ops_par_loop_taylor_green_vortex_block0_13_kernel("Save equations", taylor_green_vortex_block, 3, iter_range13,
      ...
      for (int stage=0; stage<3; stage++){
         ...
         ops_par_loop_taylor_green_vortex_block0_1_kernel("D(u0 x2)", taylor_green_vortex_block, 3, iter_range1,
                      ops_arg_dat(u0, 1, stencil1, "double", OPS_READ),
                      ops_arg_dat(wk0, 1, stencil0, "double", OPS_WRITE));

         int iter_range2[] = {0, nx0, 0, nx1, 0, nx2};
         ops_par_loop_taylor_green_vortex_block0_2_kernel("D(u0 x1)", taylor_green_vortex_block, 3, iter_range2,
                      ops_arg_dat(u0, 1, stencil2, "double", OPS_READ),
                      ops_arg_dat(wk1, 1, stencil0, "double", OPS_WRITE));

         int iter_range3[] = {0, nx0, 0, nx1, -2, nx2 + 2};
         ops_par_loop_taylor_green_vortex_block0_3_kernel("D(u2 x0)", taylor_green_vortex_block, 3, iter_range3,
                      ops_arg_dat(u2, 1, stencil3, "double", OPS_READ),
                      ops_arg_dat(wk2, 1, stencil0, "double", OPS_WRITE));

         int iter_range4[] = {0, nx0, 0, nx1, -2, nx2 + 2};
         ops_par_loop_taylor_green_vortex_block0_4_kernel("D(u1[x0 x1 x2 t] x1)", taylor_green_vortex_block, 3, iter_range4,
                      ops_arg_dat(u1, 1, stencil2, "double", OPS_READ),
                      ops_arg_dat(wk3, 1, stencil0, "double", OPS_WRITE));

         int iter_range5[] = {0, nx0, -2, nx1 + 2, 0, nx2};
         ops_par_loop_taylor_green_vortex_block0_5_kernel("D(u1[x0 x1 x2 t] x0)", taylor_green_vortex_block, 3, iter_range5,
                      ops_arg_dat(u1, 1, stencil3, "double", OPS_READ),
                      ops_arg_dat(wk4, 1, stencil0, "double", OPS_WRITE));

         int iter_range6[] = {0, nx0, 0, nx1, -2, nx2 + 2};
         ops_par_loop_taylor_green_vortex_block0_6_kernel("D(u2 x1)", taylor_green_vortex_block, 3, iter_range6,
         ...
         ops_par_loop_taylor_green_vortex_block0_7_kernel("D(u0 x0)", taylor_green_vortex_block, 3, iter_range7,
                      ops_arg_dat(u0, 1, stencil3, "double", OPS_READ),
                      ops_arg_dat(wk6, 1, stencil0, "double", OPS_WRITE));

         int iter_range8[] = {0, nx0, 0, nx1, 0, nx2};
         ops_par_loop_taylor_green_vortex_block0_8_kernel("D(u2 x2)", taylor_green_vortex_block, 3, iter_range8,
                      ops_arg_dat(u2, 1, stencil1, "double", OPS_READ),
                      ops_arg_dat(wk7, 1, stencil0, "double", OPS_WRITE));

         int iter_range9[] = {0, nx0, 0, nx1, 0, nx2};
         ops_par_loop_taylor_green_vortex_block0_9_kernel("D(u1[x0 x1 x2 t] x2)", taylor_green_vortex_block, 3, iter_range9,
                      ops_arg_dat(u1, 1, stencil1, "double", OPS_READ),
                      ops_arg_dat(wk8, 1, stencil0, "double", OPS_WRITE));

         int iter_range10[] = {0, nx0, 0, nx1, 0, nx2};
         ops_par_loop_taylor_green_vortex_block0_10_kernel("Residual of equation", taylor_green_vortex_block, 3, iter_range10,
         ...
         ops_par_loop_taylor_green_vortex_block0_11_kernel("RK new (subloop) update", taylor_green_vortex_block, 3, iter_range11,
         ...
         ops_par_loop_taylor_green_vortex_block0_12_kernel("RK old update", taylor_green_vortex_block, 3, iter_range12,
                      ops_arg_dat(wk11, 1, stencil0, "double", OPS_READ),
                      ops_arg_dat(wk12, 1, stencil0, "double", OPS_READ),
                      ops_arg_dat(wk10, 1, stencil0, "double", OPS_READ),
                      ops_arg_dat(wk9, 1, stencil0, "double", OPS_READ),
