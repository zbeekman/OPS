...
void buildOpenCLKernels_update_halo_kernel4_minus_2_b(int xdim0, int ydim0,
                                                      int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel4_minus_2_b) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/update_halo_kernel4_minus_2_b.cl"};
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_update_halo_kernel4_minus_2_b=%d  "
                           "-Dydim0_update_halo_kernel4_minus_2_b=%d  "
                           "-Dxdim1_update_halo_kernel4_minus_2_b=%d  "
                           "-Dydim1_update_halo_kernel4_minus_2_b=%d ",
    ...
    OPS_opencl_core.kernel[120] = clCreateKernel(
        OPS_opencl_core.program, "ops_update_halo_kernel4_minus_2_b", &ret);
    clSafeCall(ret);
...
void ops_par_loop_update_halo_kernel4_minus_2_b(char const *name,
  ...
  buildOpenCLKernels_update_halo_kernel4_minus_2_b(xdim0, ydim0, xdim1, ydim1);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 0, sizeof(cl_mem),
                            (void *)&arg0.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 2, sizeof(cl_int),
                            (void *)arg2.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 3, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 4, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 5, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 6, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[120], 7, sizeof(cl_int),
                            (void *)&z_size));

  // call/enque opencl kernel wrapper function
  clSafeCall(clEnqueueNDRangeKernel(
      OPS_opencl_core.command_queue, OPS_opencl_core.kernel[120], 3, NULL,
