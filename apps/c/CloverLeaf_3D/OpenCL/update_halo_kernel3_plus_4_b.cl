...
// user function
inline void update_halo_kernel3_plus_4_b(__global double *restrict vol_flux_x,
...
__kernel void ops_update_halo_kernel3_plus_4_b(__global double *restrict arg0,
