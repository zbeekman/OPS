...
static bool isbuilt_update_halo_kernel2_zvel_minus_2_front = false;

void buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_front(int xdim0,
                                                               int ydim0,
                                                               int xdim1,
                                                               int ydim1) {

  // int ocl_fma = OCL_FMA;
  if (!isbuilt_update_halo_kernel2_zvel_minus_2_front) {
    buildOpenCLKernels();
    // clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char *source_filename[1] = {
        (char *)"./OpenCL/update_halo_kernel2_zvel_minus_2_front.cl"};
    ...
    printf("Compiling update_halo_kernel2_zvel_minus_2_front %d source -- "
           "start \n",
           OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_update_halo_kernel2_zvel_minus_2_front=%d  "
                           "-Dydim0_update_halo_kernel2_zvel_minus_2_front=%d  "
                           "-Dxdim1_update_halo_kernel2_zvel_minus_2_front=%d  "
                           "-Dydim1_update_halo_kernel2_zvel_minus_2_front=%d ",
    ...
    isbuilt_update_halo_kernel2_zvel_minus_2_front = true;
  }
}
...
void ops_par_loop_update_halo_kernel2_zvel_minus_2_front(
  ...
  buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_front(xdim0, ydim0, xdim1,
                                                            ydim1);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[104], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[104], 2, sizeof(cl_int),
                            (void *)arg2.data));
