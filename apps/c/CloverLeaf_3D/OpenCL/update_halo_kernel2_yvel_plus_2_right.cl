...
// user function
inline void
update_halo_kernel2_yvel_plus_2_right(__global double *restrict yvel0,
...
__kernel void ops_update_halo_kernel2_yvel_plus_2_right(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_yvel_plus_2_right(
