...
void buildOpenCLKernels_update_halo_kernel1_b1(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_update_halo_kernel1_b1) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           ...
                           "-Dydim0_update_halo_kernel1_b1=%d  "
                           "-Dxdim1_update_halo_kernel1_b1=%d  "
                           "-Dydim1_update_halo_kernel1_b1=%d  "
                           "-Dxdim2_update_halo_kernel1_b1=%d  "
                           "-Dydim2_update_halo_kernel1_b1=%d  "
                           "-Dxdim3_update_halo_kernel1_b1=%d  "
                           "-Dydim3_update_halo_kernel1_b1=%d  "
                           "-Dxdim4_update_halo_kernel1_b1=%d  "
                           "-Dydim4_update_halo_kernel1_b1=%d  "
                           "-Dxdim5_update_halo_kernel1_b1=%d  "
                           "-Dydim5_update_halo_kernel1_b1=%d  "
                           "-Dxdim6_update_halo_kernel1_b1=%d  "
                           "-Dydim6_update_halo_kernel1_b1=%d ",
    ...
    OPS_opencl_core.kernel[58] = clCreateKernel(
...
void ops_par_loop_update_halo_kernel1_b1(char const *name, ops_block block,
  ...
  buildOpenCLKernels_update_halo_kernel1_b1(xdim0, ydim0, xdim1, ydim1, xdim2,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 2, sizeof(cl_mem),
                            (void *)&arg2.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 7, sizeof(cl_int),
                            (void *)arg7.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 8, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 9, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 10, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 11, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 12, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 13, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 14, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 15, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 16, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[58], 17, sizeof(cl_int),
                            (void *)&z_size));
