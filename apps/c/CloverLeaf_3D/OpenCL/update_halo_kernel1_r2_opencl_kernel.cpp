...
void buildOpenCLKernels_update_halo_kernel1_r2(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           ...
                           "-Dydim0_update_halo_kernel1_r2=%d  "
                           "-Dxdim1_update_halo_kernel1_r2=%d  "
                           "-Dydim1_update_halo_kernel1_r2=%d  "
                           "-Dxdim2_update_halo_kernel1_r2=%d  "
                           "-Dydim2_update_halo_kernel1_r2=%d  "
                           "-Dxdim3_update_halo_kernel1_r2=%d  "
                           "-Dydim3_update_halo_kernel1_r2=%d  "
                           "-Dxdim4_update_halo_kernel1_r2=%d  "
                           "-Dydim4_update_halo_kernel1_r2=%d  "
                           "-Dxdim5_update_halo_kernel1_r2=%d  "
                           "-Dydim5_update_halo_kernel1_r2=%d  "
                           "-Dxdim6_update_halo_kernel1_r2=%d  "
                           "-Dydim6_update_halo_kernel1_r2=%d ",
...
void ops_par_loop_update_halo_kernel1_r2(char const *name, ops_block block,
  ...
  buildOpenCLKernels_update_halo_kernel1_r2(xdim0, ydim0, xdim1, ydim1, xdim2,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[63], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[63], 7, sizeof(cl_int),
                            (void *)arg7.data));
