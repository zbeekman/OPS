...
void buildOpenCLKernels_update_halo_kernel3_plus_2_a(int xdim0, int ydim0,
                                                     int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel3_plus_2_a) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/update_halo_kernel3_plus_2_a.cl"};
    ...
    printf("Compiling update_halo_kernel3_plus_2_a %d source -- start \n",
           OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_update_halo_kernel3_plus_2_a=%d  "
                           "-Dydim0_update_halo_kernel3_plus_2_a=%d  "
                           "-Dxdim1_update_halo_kernel3_plus_2_a=%d  "
                           "-Dydim1_update_halo_kernel3_plus_2_a=%d ",
    ...
    OPS_opencl_core.kernel[106] = clCreateKernel(
        OPS_opencl_core.program, "ops_update_halo_kernel3_plus_2_a", &ret);
    clSafeCall(ret);
...
void ops_par_loop_update_halo_kernel3_plus_2_a(char const *name,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 0, sizeof(cl_mem),
                            (void *)&arg0.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 2, sizeof(cl_int),
                            (void *)arg2.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 3, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 4, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 5, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 6, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[106], 7, sizeof(cl_int),
                            (void *)&z_size));

  // call/enque opencl kernel wrapper function
  clSafeCall(clEnqueueNDRangeKernel(
      OPS_opencl_core.command_queue, OPS_opencl_core.kernel[106], 3, NULL,
