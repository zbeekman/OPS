...
__device__
    ...
    inline void
    update_halo_kernel5_plus_2_right_gpu(double *vol_flux_z,
                                         double *mass_flux_z,
                                         const int *fields) {
...
__global__ void ops_update_halo_kernel5_plus_2_right(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel5_plus_2_right +
          idx_z * 1 * 1 * xdim0_update_halo_kernel5_plus_2_right *
              ydim0_update_halo_kernel5_plus_2_right;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel5_plus_2_right +
...
void ops_par_loop_update_halo_kernel5_plus_2_right(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel5_plus_2_right_h ||
      ydim0 != ydim0_update_halo_kernel5_plus_2_right_h ||
      xdim1 != xdim1_update_halo_kernel5_plus_2_right_h ||
      ydim1 != ydim1_update_halo_kernel5_plus_2_right_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel5_plus_2_right, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel5_plus_2_right_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel5_plus_2_right, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel5_plus_2_right_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel5_plus_2_right, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel5_plus_2_right_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel5_plus_2_right, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel5_plus_2_right<<<grid, tblock>>>(
