...
__device__
    ...
    inline void
    update_halo_kernel2_zvel_minus_2_front_gpu(double *zvel0, double *zvel1,
                                               const int *fields) {
...
__global__ void ops_update_halo_kernel2_zvel_minus_2_front(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel2_zvel_minus_2_front +
          idx_z * 1 * 1 * xdim0_update_halo_kernel2_zvel_minus_2_front *
              ydim0_update_halo_kernel2_zvel_minus_2_front;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel2_zvel_minus_2_front +
          idx_z * 1 * 1 * xdim1_update_halo_kernel2_zvel_minus_2_front *
              ydim1_update_halo_kernel2_zvel_minus_2_front;
...
void ops_par_loop_update_halo_kernel2_zvel_minus_2_front(
  ...
  if (xdim0 != xdim0_update_halo_kernel2_zvel_minus_2_front_h ||
    ...
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_zvel_minus_2_front, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_zvel_minus_2_front_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_zvel_minus_2_front, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_zvel_minus_2_front_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_zvel_minus_2_front, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_zvel_minus_2_front_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_zvel_minus_2_front, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_zvel_minus_2_front<<<grid, tblock>>>(
