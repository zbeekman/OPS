...
__device__
    ...
    inline void
    update_halo_kernel2_xvel_minus_4_right_gpu(double *xvel0, double *xvel1,
                                               const int *fields) {
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_right(
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_minus_4_right_h ||
      ydim0 != ydim0_update_halo_kernel2_xvel_minus_4_right_h ||
      xdim1 != xdim1_update_halo_kernel2_xvel_minus_4_right_h ||
      ydim1 != ydim1_update_halo_kernel2_xvel_minus_4_right_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_xvel_minus_4_right, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_xvel_minus_4_right_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_xvel_minus_4_right, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_xvel_minus_4_right_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_xvel_minus_4_right, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_xvel_minus_4_right_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_xvel_minus_4_right, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_xvel_minus_4_right<<<grid, tblock>>>(
