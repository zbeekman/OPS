...
__device__
    ...
    inline void
    update_halo_kernel2_yvel_plus_4_left_gpu(double *yvel0, double *yvel1,
                                             const int *fields) {
...
__global__ void ops_update_halo_kernel2_yvel_plus_4_left(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel2_yvel_plus_4_left +
          idx_z * 1 * 1 * xdim0_update_halo_kernel2_yvel_plus_4_left *
              ydim0_update_halo_kernel2_yvel_plus_4_left;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel2_yvel_plus_4_left +
...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_left(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_4_left_h ||
      ydim0 != ydim0_update_halo_kernel2_yvel_plus_4_left_h ||
      xdim1 != xdim1_update_halo_kernel2_yvel_plus_4_left_h ||
      ydim1 != ydim1_update_halo_kernel2_yvel_plus_4_left_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_yvel_plus_4_left, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_yvel_plus_4_left_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_yvel_plus_4_left, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_yvel_plus_4_left_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_yvel_plus_4_left, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_yvel_plus_4_left_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_yvel_plus_4_left, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_yvel_plus_4_left<<<grid, tblock>>>(
