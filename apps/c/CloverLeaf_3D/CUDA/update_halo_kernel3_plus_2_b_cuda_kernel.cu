...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel3_plus_2_b * (y) +                              \
   xdim0_update_halo_kernel3_plus_2_b * ydim0_update_halo_kernel3_plus_2_b *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel3_plus_2_b * (y) +                              \
   xdim1_update_halo_kernel3_plus_2_b * ydim1_update_halo_kernel3_plus_2_b *   \
       (z))
...
__device__
    ...
    inline void
    update_halo_kernel3_plus_2_b_gpu(double *vol_flux_x, double *mass_flux_x,
                                     const int *fields) {
...
__global__ void ops_update_halo_kernel3_plus_2_b(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel3_plus_2_b +
          idx_z * 1 * 1 * xdim0_update_halo_kernel3_plus_2_b *
              ydim0_update_halo_kernel3_plus_2_b;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel3_plus_2_b +
          idx_z * 1 * 1 * xdim1_update_halo_kernel3_plus_2_b *
              ydim1_update_halo_kernel3_plus_2_b;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel3_plus_2_b_gpu(arg0, arg1, &arg2);
  }
}
...
void ops_par_loop_update_halo_kernel3_plus_2_b(char const *name,
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 3, range, 108))
    return;
#endif
  ...
  if (xdim0 != xdim0_update_halo_kernel3_plus_2_b_h ||
      ydim0 != ydim0_update_halo_kernel3_plus_2_b_h ||
      xdim1 != xdim1_update_halo_kernel3_plus_2_b_h ||
      ydim1 != ydim1_update_halo_kernel3_plus_2_b_h) {
  ...
  ops_update_halo_kernel3_plus_2_b<<<grid, tblock>>>(
