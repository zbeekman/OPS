...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel5_plus_2_b * (y) +                              \
   xdim0_update_halo_kernel5_plus_2_b * ydim0_update_halo_kernel5_plus_2_b *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel5_plus_2_b * (y) +                              \
   xdim1_update_halo_kernel5_plus_2_b * ydim1_update_halo_kernel5_plus_2_b *   \
       (z))
...
__device__
    ...
    inline void
    update_halo_kernel5_plus_2_b_gpu(double *vol_flux_z, double *mass_flux_z,
                                     const int *fields) {
...
__global__ void ops_update_halo_kernel5_plus_2_b(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel5_plus_2_b +
          idx_z * 1 * 1 * xdim0_update_halo_kernel5_plus_2_b *
              ydim0_update_halo_kernel5_plus_2_b;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel5_plus_2_b +
          idx_z * 1 * 1 * xdim1_update_halo_kernel5_plus_2_b *
              ydim1_update_halo_kernel5_plus_2_b;
...
// host stub function
void ops_par_loop_update_halo_kernel5_plus_2_b(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel5_plus_2_b_h ||
      ydim0 != ydim0_update_halo_kernel5_plus_2_b_h ||
      xdim1 != xdim1_update_halo_kernel5_plus_2_b_h ||
      ydim1 != ydim1_update_halo_kernel5_plus_2_b_h) {
  ...
  ops_update_halo_kernel5_plus_2_b<<<grid, tblock>>>(
