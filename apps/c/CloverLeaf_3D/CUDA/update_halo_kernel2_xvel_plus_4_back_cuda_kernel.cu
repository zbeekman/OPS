...
__device__
    ...
    inline void
    update_halo_kernel2_xvel_plus_4_back_gpu(double *xvel0, double *xvel1,
                                             const int *fields) {
...
__global__ void ops_update_halo_kernel2_xvel_plus_4_back(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel2_xvel_plus_4_back +
          idx_z * 1 * 1 * xdim0_update_halo_kernel2_xvel_plus_4_back *
              ydim0_update_halo_kernel2_xvel_plus_4_back;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel2_xvel_plus_4_back +
          idx_z * 1 * 1 * xdim1_update_halo_kernel2_xvel_plus_4_back *
...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_back(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_plus_4_back_h ||
    ...
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_xvel_plus_4_back, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_xvel_plus_4_back_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_xvel_plus_4_back, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_xvel_plus_4_back_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_xvel_plus_4_back, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_xvel_plus_4_back_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_xvel_plus_4_back, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_xvel_plus_4_back<<<grid, tblock>>>(
