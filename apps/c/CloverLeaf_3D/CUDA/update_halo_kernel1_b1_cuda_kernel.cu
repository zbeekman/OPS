...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel1_b1 * (y) +                                    \
   xdim0_update_halo_kernel1_b1 * ydim0_update_halo_kernel1_b1 * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel1_b1 * (y) +                                    \
   xdim1_update_halo_kernel1_b1 * ydim1_update_halo_kernel1_b1 * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + xdim2_update_halo_kernel1_b1 * (y) +                                    \
   xdim2_update_halo_kernel1_b1 * ydim2_update_halo_kernel1_b1 * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + xdim3_update_halo_kernel1_b1 * (y) +                                    \
   xdim3_update_halo_kernel1_b1 * ydim3_update_halo_kernel1_b1 * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + xdim4_update_halo_kernel1_b1 * (y) +                                    \
   xdim4_update_halo_kernel1_b1 * ydim4_update_halo_kernel1_b1 * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + xdim5_update_halo_kernel1_b1 * (y) +                                    \
   xdim5_update_halo_kernel1_b1 * ydim5_update_halo_kernel1_b1 * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + xdim6_update_halo_kernel1_b1 * (y) +                                    \
   xdim6_update_halo_kernel1_b1 * ydim6_update_halo_kernel1_b1 * (z))
...
__global__ void ops_update_halo_kernel1_b1(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim0_update_halo_kernel1_b1 *
              ydim0_update_halo_kernel1_b1;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim1_update_halo_kernel1_b1 *
              ydim1_update_halo_kernel1_b1;
  ...
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim3_update_halo_kernel1_b1 *
              ydim3_update_halo_kernel1_b1;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim4_update_halo_kernel1_b1 *
              ydim4_update_halo_kernel1_b1;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim5_update_halo_kernel1_b1 *
              ydim5_update_halo_kernel1_b1;
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim6_update_halo_kernel1_b1 +
          idx_z * 1 * 1 * xdim6_update_halo_kernel1_b1 *
              ydim6_update_halo_kernel1_b1;
...
void ops_par_loop_update_halo_kernel1_b1(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_update_halo_kernel1_b1_h ||
      ydim0 != ydim0_update_halo_kernel1_b1_h ||
      xdim1 != xdim1_update_halo_kernel1_b1_h ||
      ydim1 != ydim1_update_halo_kernel1_b1_h ||
      xdim2 != xdim2_update_halo_kernel1_b1_h ||
      ydim2 != ydim2_update_halo_kernel1_b1_h ||
      xdim3 != xdim3_update_halo_kernel1_b1_h ||
      ydim3 != ydim3_update_halo_kernel1_b1_h ||
      xdim4 != xdim4_update_halo_kernel1_b1_h ||
      ydim4 != ydim4_update_halo_kernel1_b1_h ||
      xdim5 != xdim5_update_halo_kernel1_b1_h ||
      ydim5 != ydim5_update_halo_kernel1_b1_h ||
      xdim6 != xdim6_update_halo_kernel1_b1_h ||
      ydim6 != ydim6_update_halo_kernel1_b1_h) {
  ...
  ops_update_halo_kernel1_b1<<<grid, tblock>>>(
