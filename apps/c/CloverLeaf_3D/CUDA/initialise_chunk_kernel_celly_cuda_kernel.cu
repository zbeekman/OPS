...
void ops_par_loop_initialise_chunk_kernel_celly(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_celly_h || ydim0 != ydim0_initialise_chunk_kernel_celly_h || xdim1 != xdim1_initialise_chunk_kernel_celly_h || ydim1 != ydim1_initialise_chunk_kernel_celly_h || xdim2 != xdim2_initialise_chunk_kernel_celly_h || ydim2 != ydim2_initialise_chunk_kernel_celly_h) {
    ...
    cudaMemcpyToSymbol( ydim0_initialise_chunk_kernel_celly, &ydim0, sizeof(int) );
    ...
    cudaMemcpyToSymbol( ydim1_initialise_chunk_kernel_celly, &ydim1, sizeof(int) );
    ...
    cudaMemcpyToSymbol( ydim2_initialise_chunk_kernel_celly, &ydim2, sizeof(int) );
