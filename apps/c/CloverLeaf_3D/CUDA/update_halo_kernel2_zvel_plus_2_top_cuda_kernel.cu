...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel2_zvel_plus_2_top * (y) +                       \
   xdim0_update_halo_kernel2_zvel_plus_2_top *                                 \
       ydim0_update_halo_kernel2_zvel_plus_2_top * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel2_zvel_plus_2_top * (y) +                       \
   xdim1_update_halo_kernel2_zvel_plus_2_top *                                 \
       ydim1_update_halo_kernel2_zvel_plus_2_top * (z))

// user function
__device__

    inline void
    update_halo_kernel2_zvel_plus_2_top_gpu(double *zvel0, double *zvel1,
                                            const int *fields) {
...
__global__ void ops_update_halo_kernel2_zvel_plus_2_top(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel2_zvel_plus_2_top +
          idx_z * 1 * 1 * xdim0_update_halo_kernel2_zvel_plus_2_top *
              ydim0_update_halo_kernel2_zvel_plus_2_top;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel2_zvel_plus_2_top +
...
// host stub function
void ops_par_loop_update_halo_kernel2_zvel_plus_2_top(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel2_zvel_plus_2_top_h ||
      ydim0 != ydim0_update_halo_kernel2_zvel_plus_2_top_h ||
      xdim1 != xdim1_update_halo_kernel2_zvel_plus_2_top_h ||
      ydim1 != ydim1_update_halo_kernel2_zvel_plus_2_top_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_zvel_plus_2_top, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_zvel_plus_2_top_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_zvel_plus_2_top, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_zvel_plus_2_top_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_zvel_plus_2_top, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_zvel_plus_2_top_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_zvel_plus_2_top, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_zvel_plus_2_top<<<grid, tblock>>>(
