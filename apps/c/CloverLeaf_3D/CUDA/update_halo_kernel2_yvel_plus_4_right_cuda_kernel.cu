...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel2_yvel_plus_4_right * (y) +                     \
   xdim0_update_halo_kernel2_yvel_plus_4_right *                               \
       ydim0_update_halo_kernel2_yvel_plus_4_right * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel2_yvel_plus_4_right * (y) +                     \
   xdim1_update_halo_kernel2_yvel_plus_4_right *                               \
       ydim1_update_halo_kernel2_yvel_plus_4_right * (z))

// user function
__device__

    inline void
    update_halo_kernel2_yvel_plus_4_right_gpu(double *yvel0, double *yvel1,
                                              const int *fields) {
...
__global__ void ops_update_halo_kernel2_yvel_plus_4_right(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim0_update_halo_kernel2_yvel_plus_4_right +
          idx_z * 1 * 1 * xdim0_update_halo_kernel2_yvel_plus_4_right *
              ydim0_update_halo_kernel2_yvel_plus_4_right;
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * xdim1_update_halo_kernel2_yvel_plus_4_right +
          idx_z * 1 * 1 * xdim1_update_halo_kernel2_yvel_plus_4_right *
...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_right(
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_4_right_h ||
      ydim0 != ydim0_update_halo_kernel2_yvel_plus_4_right_h ||
      xdim1 != xdim1_update_halo_kernel2_yvel_plus_4_right_h ||
      ydim1 != ydim1_update_halo_kernel2_yvel_plus_4_right_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel2_yvel_plus_4_right, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel2_yvel_plus_4_right_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel2_yvel_plus_4_right, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel2_yvel_plus_4_right_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel2_yvel_plus_4_right, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel2_yvel_plus_4_right_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel2_yvel_plus_4_right, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel2_yvel_plus_4_right<<<grid, tblock>>>(
