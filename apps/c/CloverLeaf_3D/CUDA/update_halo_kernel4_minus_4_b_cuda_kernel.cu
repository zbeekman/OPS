...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel4_minus_4_b * (y) +                             \
   xdim0_update_halo_kernel4_minus_4_b * ydim0_update_halo_kernel4_minus_4_b * \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel4_minus_4_b * (y) +                             \
   xdim1_update_halo_kernel4_minus_4_b * ydim1_update_halo_kernel4_minus_4_b * \
       (z))
...
__device__
    ...
    inline void
    update_halo_kernel4_minus_4_b_gpu(double *vol_flux_y, double *mass_flux_y,
                                      const int *fields) {
...
__global__ void ops_update_halo_kernel4_minus_4_b(double *__restrict arg0,
  ...
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel4_minus_4_b +
          idx_z * 1 * 1 * xdim1_update_halo_kernel4_minus_4_b *
              ydim1_update_halo_kernel4_minus_4_b;
...
void ops_par_loop_update_halo_kernel4_minus_4_b(char const *name,
  ...
  if (xdim0 != xdim0_update_halo_kernel4_minus_4_b_h ||
      ydim0 != ydim0_update_halo_kernel4_minus_4_b_h ||
      xdim1 != xdim1_update_halo_kernel4_minus_4_b_h ||
      ydim1 != ydim1_update_halo_kernel4_minus_4_b_h) {
    cudaMemcpyToSymbol(xdim0_update_halo_kernel4_minus_4_b, &xdim0,
                       sizeof(int));
    xdim0_update_halo_kernel4_minus_4_b_h = xdim0;
    cudaMemcpyToSymbol(ydim0_update_halo_kernel4_minus_4_b, &ydim0,
                       sizeof(int));
    ydim0_update_halo_kernel4_minus_4_b_h = ydim0;
    cudaMemcpyToSymbol(xdim1_update_halo_kernel4_minus_4_b, &xdim1,
                       sizeof(int));
    xdim1_update_halo_kernel4_minus_4_b_h = xdim1;
    cudaMemcpyToSymbol(ydim1_update_halo_kernel4_minus_4_b, &ydim1,
                       sizeof(int));
  ...
  ops_update_halo_kernel4_minus_4_b<<<grid, tblock>>>(
