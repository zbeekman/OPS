...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_update_halo_kernel1_ba1 * (y) +                                   \
   xdim0_update_halo_kernel1_ba1 * ydim0_update_halo_kernel1_ba1 * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_update_halo_kernel1_ba1 * (y) +                                   \
   xdim1_update_halo_kernel1_ba1 * ydim1_update_halo_kernel1_ba1 * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + xdim2_update_halo_kernel1_ba1 * (y) +                                   \
   xdim2_update_halo_kernel1_ba1 * ydim2_update_halo_kernel1_ba1 * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + xdim3_update_halo_kernel1_ba1 * (y) +                                   \
   xdim3_update_halo_kernel1_ba1 * ydim3_update_halo_kernel1_ba1 * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + xdim4_update_halo_kernel1_ba1 * (y) +                                   \
   xdim4_update_halo_kernel1_ba1 * ydim4_update_halo_kernel1_ba1 * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + xdim5_update_halo_kernel1_ba1 * (y) +                                   \
   xdim5_update_halo_kernel1_ba1 * ydim5_update_halo_kernel1_ba1 * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + xdim6_update_halo_kernel1_ba1 * (y) +                                   \
   xdim6_update_halo_kernel1_ba1 * ydim6_update_halo_kernel1_ba1 * (z))

// user function
__device__

    inline void
    update_halo_kernel1_ba1_gpu(double *density0, double *density1,
...
__global__ void ops_update_halo_kernel1_ba1(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim0_update_halo_kernel1_ba1 *
              ydim0_update_halo_kernel1_ba1;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim1_update_halo_kernel1_ba1 *
              ydim1_update_halo_kernel1_ba1;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim2_update_halo_kernel1_ba1 *
              ydim2_update_halo_kernel1_ba1;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim3_update_halo_kernel1_ba1 *
              ydim3_update_halo_kernel1_ba1;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim4_update_halo_kernel1_ba1 *
              ydim4_update_halo_kernel1_ba1;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim5_update_halo_kernel1_ba1 *
              ydim5_update_halo_kernel1_ba1;
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim6_update_halo_kernel1_ba1 +
          idx_z * 1 * 1 * xdim6_update_halo_kernel1_ba1 *
              ydim6_update_halo_kernel1_ba1;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel1_ba1_gpu(arg0, arg1, arg2, arg3, arg4, arg5, arg6,
                                &arg7);
  }
}
...
void ops_par_loop_update_halo_kernel1_ba1(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_update_halo_kernel1_ba1_h ||
      ydim0 != ydim0_update_halo_kernel1_ba1_h ||
      xdim1 != xdim1_update_halo_kernel1_ba1_h ||
      ydim1 != ydim1_update_halo_kernel1_ba1_h ||
      xdim2 != xdim2_update_halo_kernel1_ba1_h ||
      ydim2 != ydim2_update_halo_kernel1_ba1_h ||
      xdim3 != xdim3_update_halo_kernel1_ba1_h ||
      ydim3 != ydim3_update_halo_kernel1_ba1_h ||
      xdim4 != xdim4_update_halo_kernel1_ba1_h ||
      ydim4 != ydim4_update_halo_kernel1_ba1_h ||
      xdim5 != xdim5_update_halo_kernel1_ba1_h ||
      ydim5 != ydim5_update_halo_kernel1_ba1_h ||
      xdim6 != xdim6_update_halo_kernel1_ba1_h ||
      ydim6 != ydim6_update_halo_kernel1_ba1_h) {
  ...
  ops_update_halo_kernel1_ba1<<<grid, tblock>>>(
