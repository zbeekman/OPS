...
void ops_par_loop_initialise_chunk_kernel_z(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_z_h || ydim0 != ydim0_initialise_chunk_kernel_z_h || xdim1 != xdim1_initialise_chunk_kernel_z_h || ydim1 != ydim1_initialise_chunk_kernel_z_h || xdim2 != xdim2_initialise_chunk_kernel_z_h || ydim2 != ydim2_initialise_chunk_kernel_z_h) {
    ...
    cudaMemcpyToSymbol( ydim1_initialise_chunk_kernel_z, &ydim1, sizeof(int) );
    ydim1_initialise_chunk_kernel_z_h = ydim1;
    cudaMemcpyToSymbol( xdim2_initialise_chunk_kernel_z, &xdim2, sizeof(int) );
    xdim2_initialise_chunk_kernel_z_h = xdim2;
    cudaMemcpyToSymbol( ydim2_initialise_chunk_kernel_z, &ydim2, sizeof(int) );
  ...
  ops_initialise_chunk_kernel_z<<<grid, tblock >>> (  (double *)p_a[0], (int *)p_a[1],
