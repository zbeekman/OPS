...
__device__
    ...
    inline void
    update_halo_kernel1_t2_gpu(double *density0, double *density1,
...
__global__ void ops_update_halo_kernel1_t2(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim0_update_halo_kernel1_t2 *
              ydim0_update_halo_kernel1_t2;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim1_update_halo_kernel1_t2 *
              ydim1_update_halo_kernel1_t2;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim2_update_halo_kernel1_t2 *
              ydim2_update_halo_kernel1_t2;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim3_update_halo_kernel1_t2 *
              ydim3_update_halo_kernel1_t2;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim4_update_halo_kernel1_t2 *
              ydim4_update_halo_kernel1_t2;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim5_update_halo_kernel1_t2 *
              ydim5_update_halo_kernel1_t2;
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim6_update_halo_kernel1_t2 +
          idx_z * 1 * 1 * xdim6_update_halo_kernel1_t2 *
              ydim6_update_halo_kernel1_t2;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel1_t2_gpu(arg0, arg1, arg2, arg3, arg4, arg5, arg6, &arg7);
  }
}
...
void ops_par_loop_update_halo_kernel1_t2(char const *name, ops_block block,
  ...
  ops_update_halo_kernel1_t2<<<grid, tblock>>>(
