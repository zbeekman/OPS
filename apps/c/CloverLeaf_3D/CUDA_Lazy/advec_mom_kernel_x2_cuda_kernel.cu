...
void ops_par_loop_advec_mom_kernel_x2_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_x2_h || ydim0 != ydim0_advec_mom_kernel_x2_h || xdim1 != xdim1_advec_mom_kernel_x2_h || ydim1 != ydim1_advec_mom_kernel_x2_h || xdim2 != xdim2_advec_mom_kernel_x2_h || ydim2 != ydim2_advec_mom_kernel_x2_h || xdim3 != xdim3_advec_mom_kernel_x2_h || ydim3 != ydim3_advec_mom_kernel_x2_h || xdim4 != xdim4_advec_mom_kernel_x2_h || ydim4 != ydim4_advec_mom_kernel_x2_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel_x2, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_mom_kernel_x2_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_x2, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_mom_kernel_x2_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel_x2, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_mom_kernel_x2_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_x2, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_mom_kernel_x2_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel_x2, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_mom_kernel_x2_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel_x2, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_mom_kernel_x2_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel_x2, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_mom_kernel_x2_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel_x2, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_mom_kernel_x2_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_mom_kernel_x2, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_mom_kernel_x2_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel_x2, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel_x2<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
