...
__constant__ int ydim0_advec_mom_kernel_post_pre_advec_y;
...
__constant__ int ydim1_advec_mom_kernel_post_pre_advec_y;
...
__constant__ int ydim2_advec_mom_kernel_post_pre_advec_y;
...
__constant__ int ydim3_advec_mom_kernel_post_pre_advec_y;
...
__constant__ int ydim4_advec_mom_kernel_post_pre_advec_y;
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel_post_pre_advec_y + idx_z * 1*1 * xdim0_advec_mom_kernel_post_pre_advec_y * ydim0_advec_mom_kernel_post_pre_advec_y;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel_post_pre_advec_y + idx_z * 1*1 * xdim1_advec_mom_kernel_post_pre_advec_y * ydim1_advec_mom_kernel_post_pre_advec_y;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_mom_kernel_post_pre_advec_y + idx_z * 1*1 * xdim2_advec_mom_kernel_post_pre_advec_y * ydim2_advec_mom_kernel_post_pre_advec_y;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_mom_kernel_post_pre_advec_y + idx_z * 1*1 * xdim3_advec_mom_kernel_post_pre_advec_y * ydim3_advec_mom_kernel_post_pre_advec_y;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_mom_kernel_post_pre_advec_y + idx_z * 1*1 * xdim4_advec_mom_kernel_post_pre_advec_y * ydim4_advec_mom_kernel_post_pre_advec_y;
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_post_pre_advec_y_h || ydim0 != ydim0_advec_mom_kernel_post_pre_advec_y_h || xdim1 != xdim1_advec_mom_kernel_post_pre_advec_y_h || ydim1 != ydim1_advec_mom_kernel_post_pre_advec_y_h || xdim2 != xdim2_advec_mom_kernel_post_pre_advec_y_h || ydim2 != ydim2_advec_mom_kernel_post_pre_advec_y_h || xdim3 != xdim3_advec_mom_kernel_post_pre_advec_y_h || ydim3 != ydim3_advec_mom_kernel_post_pre_advec_y_h || xdim4 != xdim4_advec_mom_kernel_post_pre_advec_y_h || ydim4 != ydim4_advec_mom_kernel_post_pre_advec_y_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_post_pre_advec_y, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_post_pre_advec_y, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel_post_pre_advec_y, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel_post_pre_advec_y, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel_post_pre_advec_y, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
