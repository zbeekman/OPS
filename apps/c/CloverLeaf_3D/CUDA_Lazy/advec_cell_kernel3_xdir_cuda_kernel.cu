...
#define OPS_ACC3(x,y,z) (x+xdim3_advec_cell_kernel3_xdir*(y)+xdim3_advec_cell_kernel3_xdir*ydim3_advec_cell_kernel3_xdir*(z))
#define OPS_ACC4(x,y,z) (x+xdim4_advec_cell_kernel3_xdir*(y)+xdim4_advec_cell_kernel3_xdir*ydim4_advec_cell_kernel3_xdir*(z))
#define OPS_ACC5(x,y,z) (x+xdim5_advec_cell_kernel3_xdir*(y)+xdim5_advec_cell_kernel3_xdir*ydim5_advec_cell_kernel3_xdir*(z))
#define OPS_ACC6(x,y,z) (x+xdim6_advec_cell_kernel3_xdir*(y)+xdim6_advec_cell_kernel3_xdir*ydim6_advec_cell_kernel3_xdir*(z))
#define OPS_ACC7(x,y,z) (x+xdim7_advec_cell_kernel3_xdir*(y)+xdim7_advec_cell_kernel3_xdir*ydim7_advec_cell_kernel3_xdir*(z))
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim0_advec_cell_kernel3_xdir * ydim0_advec_cell_kernel3_xdir;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim1_advec_cell_kernel3_xdir * ydim1_advec_cell_kernel3_xdir;
  arg2 += idx_x * 1*1 + idx_y * 0*1 * xdim2_advec_cell_kernel3_xdir + idx_z * 0*1 * xdim2_advec_cell_kernel3_xdir * ydim2_advec_cell_kernel3_xdir;
  arg3 += idx_x * 1*1 + idx_y * 0*1 * xdim3_advec_cell_kernel3_xdir + idx_z * 0*1 * xdim3_advec_cell_kernel3_xdir * ydim3_advec_cell_kernel3_xdir;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim4_advec_cell_kernel3_xdir * ydim4_advec_cell_kernel3_xdir;
  arg5 += idx_x * 1*1 + idx_y * 1*1 * xdim5_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim5_advec_cell_kernel3_xdir * ydim5_advec_cell_kernel3_xdir;
  arg6 += idx_x * 1*1 + idx_y * 1*1 * xdim6_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim6_advec_cell_kernel3_xdir * ydim6_advec_cell_kernel3_xdir;
  arg7 += idx_x * 1*1 + idx_y * 1*1 * xdim7_advec_cell_kernel3_xdir + idx_z * 1*1 * xdim7_advec_cell_kernel3_xdir * ydim7_advec_cell_kernel3_xdir;
...
void ops_par_loop_advec_cell_kernel3_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel3_xdir_h || ydim0 != ydim0_advec_cell_kernel3_xdir_h || xdim1 != xdim1_advec_cell_kernel3_xdir_h || ydim1 != ydim1_advec_cell_kernel3_xdir_h || xdim2 != xdim2_advec_cell_kernel3_xdir_h || ydim2 != ydim2_advec_cell_kernel3_xdir_h || xdim3 != xdim3_advec_cell_kernel3_xdir_h || ydim3 != ydim3_advec_cell_kernel3_xdir_h || xdim4 != xdim4_advec_cell_kernel3_xdir_h || ydim4 != ydim4_advec_cell_kernel3_xdir_h || xdim5 != xdim5_advec_cell_kernel3_xdir_h || ydim5 != ydim5_advec_cell_kernel3_xdir_h || xdim6 != xdim6_advec_cell_kernel3_xdir_h || ydim6 != ydim6_advec_cell_kernel3_xdir_h || xdim7 != xdim7_advec_cell_kernel3_xdir_h || ydim7 != ydim7_advec_cell_kernel3_xdir_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel3_xdir, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel3_xdir, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel3_xdir, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel3_xdir, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim4_advec_cell_kernel3_xdir, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim5_advec_cell_kernel3_xdir, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim6_advec_cell_kernel3_xdir, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim7_advec_cell_kernel3_xdir, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
