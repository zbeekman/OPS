...
//
__constant__ int xdim0_update_halo_kernel2_zvel_plus_4_top;
int xdim0_update_halo_kernel2_zvel_plus_4_top_h = -1;
__constant__ int ydim0_update_halo_kernel2_zvel_plus_4_top;
int ydim0_update_halo_kernel2_zvel_plus_4_top_h = -1;
__constant__ int xdim1_update_halo_kernel2_zvel_plus_4_top;
int xdim1_update_halo_kernel2_zvel_plus_4_top_h = -1;
__constant__ int ydim1_update_halo_kernel2_zvel_plus_4_top;
...
#define OPS_ACC0(x,y,z) (x+xdim0_update_halo_kernel2_zvel_plus_4_top*(y)+xdim0_update_halo_kernel2_zvel_plus_4_top*ydim0_update_halo_kernel2_zvel_plus_4_top*(z))
#define OPS_ACC1(x,y,z) (x+xdim1_update_halo_kernel2_zvel_plus_4_top*(y)+xdim1_update_halo_kernel2_zvel_plus_4_top*ydim1_update_halo_kernel2_zvel_plus_4_top*(z))

//user function
__device__

inline void update_halo_kernel2_zvel_plus_4_top_gpu(double *zvel0, double *zvel1, const int* fields)
{
  if((*fields) & FIELD_ZVEL0) zvel0[OPS_ACC0(0,0,0)] = zvel0[OPS_ACC0(0,-4,0)];
  if((*fields) & FIELD_ZVEL1) zvel1[OPS_ACC1(0,0,0)] = zvel1[OPS_ACC1(0,-4,0)];
}
...
__global__ void ops_update_halo_kernel2_zvel_plus_4_top(
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_zvel_plus_4_top_gpu(arg0, arg1, &arg2);
  }
...
// host stub function
// host stub function
void ops_par_loop_update_halo_kernel2_zvel_plus_4_top_execute(ops_kernel_descriptor *desc) {
  #ifdef OPS_MPI
  ...
  if (xdim0 != xdim0_update_halo_kernel2_zvel_plus_4_top_h || ydim0 != ydim0_update_halo_kernel2_zvel_plus_4_top_h || xdim1 != xdim1_update_halo_kernel2_zvel_plus_4_top_h || ydim1 != ydim1_update_halo_kernel2_zvel_plus_4_top_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_zvel_plus_4_top, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_zvel_plus_4_top_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel2_zvel_plus_4_top, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel2_zvel_plus_4_top_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_zvel_plus_4_top, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel2_zvel_plus_4_top_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel2_zvel_plus_4_top, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_zvel_plus_4_top<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
...
void ops_par_loop_update_halo_kernel2_zvel_plus_4_top(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  desc->function = ops_par_loop_update_halo_kernel2_zvel_plus_4_top_execute;
  if (OPS_diags > 1) {
    ops_timing_realloc(95,"update_halo_kernel2_zvel_plus_4_top");
  }
