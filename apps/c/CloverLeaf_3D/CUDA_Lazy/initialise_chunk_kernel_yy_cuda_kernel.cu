...
void initialise_chunk_kernel_yy_gpu(int *yy, int *idx) {
...
int size2 ){
  ...
  arg0 += idx_x * 0*1 + idx_y * 1*1 * xdim0_initialise_chunk_kernel_yy + idx_z * 0*1 * xdim0_initialise_chunk_kernel_yy * ydim0_initialise_chunk_kernel_yy;
...
void ops_par_loop_initialise_chunk_kernel_yy_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_yy_h || ydim0 != ydim0_initialise_chunk_kernel_yy_h) {
    cudaMemcpyToSymbolAsync( xdim0_initialise_chunk_kernel_yy, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_initialise_chunk_kernel_yy_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_yy, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_yy<<<grid, tblock, 0, stream >>> (  (int *)p_a[0], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
