...
void ops_par_loop_update_halo_kernel5_minus_2_back_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel5_minus_2_back_h || ydim0 != ydim0_update_halo_kernel5_minus_2_back_h || xdim1 != xdim1_update_halo_kernel5_minus_2_back_h || ydim1 != ydim1_update_halo_kernel5_minus_2_back_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel5_minus_2_back, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel5_minus_2_back_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel5_minus_2_back, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel5_minus_2_back_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel5_minus_2_back, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel5_minus_2_back_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel5_minus_2_back, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel5_minus_2_back<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
