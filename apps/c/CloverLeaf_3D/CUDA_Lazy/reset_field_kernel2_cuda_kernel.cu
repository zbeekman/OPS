...
void ops_par_loop_reset_field_kernel2_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_reset_field_kernel2_h || ydim0 != ydim0_reset_field_kernel2_h || xdim1 != xdim1_reset_field_kernel2_h || ydim1 != ydim1_reset_field_kernel2_h || xdim2 != xdim2_reset_field_kernel2_h || ydim2 != ydim2_reset_field_kernel2_h || xdim3 != xdim3_reset_field_kernel2_h || ydim3 != ydim3_reset_field_kernel2_h || xdim4 != xdim4_reset_field_kernel2_h || ydim4 != ydim4_reset_field_kernel2_h || xdim5 != xdim5_reset_field_kernel2_h || ydim5 != ydim5_reset_field_kernel2_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_reset_field_kernel2, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_reset_field_kernel2, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_reset_field_kernel2, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_reset_field_kernel2, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_reset_field_kernel2_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_reset_field_kernel2, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_reset_field_kernel2_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_reset_field_kernel2, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_reset_field_kernel2_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_reset_field_kernel2, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_reset_field_kernel2_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_reset_field_kernel2, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
