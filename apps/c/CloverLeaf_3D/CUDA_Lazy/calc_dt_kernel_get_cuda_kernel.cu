...
void ops_par_loop_calc_dt_kernel_get_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_calc_dt_kernel_get_h || ydim0 != ydim0_calc_dt_kernel_get_h || xdim1 != xdim1_calc_dt_kernel_get_h || ydim1 != ydim1_calc_dt_kernel_get_h || xdim4 != xdim4_calc_dt_kernel_get_h || ydim4 != ydim4_calc_dt_kernel_get_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_calc_dt_kernel_get, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_calc_dt_kernel_get, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_calc_dt_kernel_get_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim4_calc_dt_kernel_get, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_calc_dt_kernel_get_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_calc_dt_kernel_get, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
