...
inline void advec_mom_kernel2_x_gpu(double *vel1, const double *node_mass_post,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel2_x + idx_z * 1*1 * xdim0_advec_mom_kernel2_x * ydim0_advec_mom_kernel2_x;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel2_x + idx_z * 1*1 * xdim1_advec_mom_kernel2_x * ydim1_advec_mom_kernel2_x;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_mom_kernel2_x + idx_z * 1*1 * xdim2_advec_mom_kernel2_x * ydim2_advec_mom_kernel2_x;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_mom_kernel2_x + idx_z * 1*1 * xdim3_advec_mom_kernel2_x * ydim3_advec_mom_kernel2_x;
...
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel2_x_h || ydim0 != ydim0_advec_mom_kernel2_x_h || xdim1 != xdim1_advec_mom_kernel2_x_h || ydim1 != ydim1_advec_mom_kernel2_x_h || xdim2 != xdim2_advec_mom_kernel2_x_h || ydim2 != ydim2_advec_mom_kernel2_x_h || xdim3 != xdim3_advec_mom_kernel2_x_h || ydim3 != ydim3_advec_mom_kernel2_x_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel2_x, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_mom_kernel2_x_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel2_x, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_mom_kernel2_x_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel2_x, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_mom_kernel2_x_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel2_x, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_mom_kernel2_x_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel2_x, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_mom_kernel2_x_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel2_x, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_mom_kernel2_x_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel2_x, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_mom_kernel2_x_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel2_x, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel2_x<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
