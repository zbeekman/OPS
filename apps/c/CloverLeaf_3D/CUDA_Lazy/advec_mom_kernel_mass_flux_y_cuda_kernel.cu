...
__constant__ int ydim0_advec_mom_kernel_mass_flux_y;
...
inline void advec_mom_kernel_mass_flux_y_gpu( double *node_flux, const double *mass_flux_y) {
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel_mass_flux_y + idx_z * 1*1 * xdim0_advec_mom_kernel_mass_flux_y * ydim0_advec_mom_kernel_mass_flux_y;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel_mass_flux_y + idx_z * 1*1 * xdim1_advec_mom_kernel_mass_flux_y * ydim1_advec_mom_kernel_mass_flux_y;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_mom_kernel_mass_flux_y_gpu(arg0, arg1);
  }
...
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_mass_flux_y_h || ydim0 != ydim0_advec_mom_kernel_mass_flux_y_h || xdim1 != xdim1_advec_mom_kernel_mass_flux_y_h || ydim1 != ydim1_advec_mom_kernel_mass_flux_y_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_mass_flux_y, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_mass_flux_y, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel_mass_flux_y<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
