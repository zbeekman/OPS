...
//
__constant__ int xdim0_initialise_chunk_kernel_z;
int xdim0_initialise_chunk_kernel_z_h = -1;
__constant__ int ydim0_initialise_chunk_kernel_z;
int ydim0_initialise_chunk_kernel_z_h = -1;
__constant__ int xdim1_initialise_chunk_kernel_z;
int xdim1_initialise_chunk_kernel_z_h = -1;
__constant__ int ydim1_initialise_chunk_kernel_z;
int ydim1_initialise_chunk_kernel_z_h = -1;
__constant__ int xdim2_initialise_chunk_kernel_z;
int xdim2_initialise_chunk_kernel_z_h = -1;
__constant__ int ydim2_initialise_chunk_kernel_z;
...
void initialise_chunk_kernel_z_gpu(double *vertexz, const int *zz, double *vertexdz) {
...
__global__ void ops_initialise_chunk_kernel_z(
...
void ops_par_loop_initialise_chunk_kernel_z_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_z_h || ydim0 != ydim0_initialise_chunk_kernel_z_h || xdim1 != xdim1_initialise_chunk_kernel_z_h || ydim1 != ydim1_initialise_chunk_kernel_z_h || xdim2 != xdim2_initialise_chunk_kernel_z_h || ydim2 != ydim2_initialise_chunk_kernel_z_h) {
    cudaMemcpyToSymbolAsync( xdim0_initialise_chunk_kernel_z, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_initialise_chunk_kernel_z_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_z, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_initialise_chunk_kernel_z_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_initialise_chunk_kernel_z, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_initialise_chunk_kernel_z_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_z, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_initialise_chunk_kernel_z_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_initialise_chunk_kernel_z, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_initialise_chunk_kernel_z_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_z, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_z<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (int *)p_a[1],
