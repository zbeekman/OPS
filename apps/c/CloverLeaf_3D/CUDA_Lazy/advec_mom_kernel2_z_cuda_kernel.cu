...
#define OPS_ACC0(x,y,z) (x+xdim0_advec_mom_kernel2_z*(y)+xdim0_advec_mom_kernel2_z*ydim0_advec_mom_kernel2_z*(z))
#define OPS_ACC1(x,y,z) (x+xdim1_advec_mom_kernel2_z*(y)+xdim1_advec_mom_kernel2_z*ydim1_advec_mom_kernel2_z*(z))
#define OPS_ACC2(x,y,z) (x+xdim2_advec_mom_kernel2_z*(y)+xdim2_advec_mom_kernel2_z*ydim2_advec_mom_kernel2_z*(z))
#define OPS_ACC3(x,y,z) (x+xdim3_advec_mom_kernel2_z*(y)+xdim3_advec_mom_kernel2_z*ydim3_advec_mom_kernel2_z*(z))

//user function
__device__

inline void advec_mom_kernel2_z_gpu( double *vel1, const double *node_mass_post,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel2_z + idx_z * 1*1 * xdim0_advec_mom_kernel2_z * ydim0_advec_mom_kernel2_z;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel2_z + idx_z * 1*1 * xdim1_advec_mom_kernel2_z * ydim1_advec_mom_kernel2_z;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_mom_kernel2_z + idx_z * 1*1 * xdim2_advec_mom_kernel2_z * ydim2_advec_mom_kernel2_z;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_mom_kernel2_z + idx_z * 1*1 * xdim3_advec_mom_kernel2_z * ydim3_advec_mom_kernel2_z;
...
void ops_par_loop_advec_mom_kernel2_z_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel2_z_h || ydim0 != ydim0_advec_mom_kernel2_z_h || xdim1 != xdim1_advec_mom_kernel2_z_h || ydim1 != ydim1_advec_mom_kernel2_z_h || xdim2 != xdim2_advec_mom_kernel2_z_h || ydim2 != ydim2_advec_mom_kernel2_z_h || xdim3 != xdim3_advec_mom_kernel2_z_h || ydim3 != ydim3_advec_mom_kernel2_z_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel2_z, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_mom_kernel2_z_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel2_z, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_mom_kernel2_z_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel2_z, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_mom_kernel2_z_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel2_z, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_mom_kernel2_z_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel2_z, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_mom_kernel2_z_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel2_z, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_mom_kernel2_z_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel2_z, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_mom_kernel2_z_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel2_z, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel2_z<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
