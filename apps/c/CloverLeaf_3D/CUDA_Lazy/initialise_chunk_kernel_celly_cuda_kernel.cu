...
void initialise_chunk_kernel_celly_gpu(const double *vertexy, double* celly, double *celldy) {
...
int size2 ){
  ...
  arg0 += idx_x * 0*1 + idx_y * 1*1 * xdim0_initialise_chunk_kernel_celly + idx_z * 0*1 * xdim0_initialise_chunk_kernel_celly * ydim0_initialise_chunk_kernel_celly;
  arg1 += idx_x * 0*1 + idx_y * 1*1 * xdim1_initialise_chunk_kernel_celly + idx_z * 0*1 * xdim1_initialise_chunk_kernel_celly * ydim1_initialise_chunk_kernel_celly;
  arg2 += idx_x * 0*1 + idx_y * 1*1 * xdim2_initialise_chunk_kernel_celly + idx_z * 0*1 * xdim2_initialise_chunk_kernel_celly * ydim2_initialise_chunk_kernel_celly;
...
void ops_par_loop_initialise_chunk_kernel_celly_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_celly_h || ydim0 != ydim0_initialise_chunk_kernel_celly_h || xdim1 != xdim1_initialise_chunk_kernel_celly_h || ydim1 != ydim1_initialise_chunk_kernel_celly_h || xdim2 != xdim2_initialise_chunk_kernel_celly_h || ydim2 != ydim2_initialise_chunk_kernel_celly_h) {
    cudaMemcpyToSymbolAsync( xdim0_initialise_chunk_kernel_celly, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_initialise_chunk_kernel_celly_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_celly, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_initialise_chunk_kernel_celly_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_initialise_chunk_kernel_celly, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_initialise_chunk_kernel_celly_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_celly, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_initialise_chunk_kernel_celly_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_initialise_chunk_kernel_celly, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_initialise_chunk_kernel_celly_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_celly, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_celly<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
