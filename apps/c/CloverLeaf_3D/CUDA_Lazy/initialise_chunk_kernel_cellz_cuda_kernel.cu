...
int size2 ){
  ...
  arg0 += idx_x * 0*1 + idx_y * 0*1 * xdim0_initialise_chunk_kernel_cellz + idx_z * 1*1 * xdim0_initialise_chunk_kernel_cellz * ydim0_initialise_chunk_kernel_cellz;
  arg1 += idx_x * 0*1 + idx_y * 0*1 * xdim1_initialise_chunk_kernel_cellz + idx_z * 1*1 * xdim1_initialise_chunk_kernel_cellz * ydim1_initialise_chunk_kernel_cellz;
  arg2 += idx_x * 0*1 + idx_y * 0*1 * xdim2_initialise_chunk_kernel_cellz + idx_z * 1*1 * xdim2_initialise_chunk_kernel_cellz * ydim2_initialise_chunk_kernel_cellz;
...
void ops_par_loop_initialise_chunk_kernel_cellz_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_cellz_h || ydim0 != ydim0_initialise_chunk_kernel_cellz_h || xdim1 != xdim1_initialise_chunk_kernel_cellz_h || ydim1 != ydim1_initialise_chunk_kernel_cellz_h || xdim2 != xdim2_initialise_chunk_kernel_cellz_h || ydim2 != ydim2_initialise_chunk_kernel_cellz_h) {
    cudaMemcpyToSymbolAsync( xdim0_initialise_chunk_kernel_cellz, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_initialise_chunk_kernel_cellz_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_cellz, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_initialise_chunk_kernel_cellz_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_initialise_chunk_kernel_cellz, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_initialise_chunk_kernel_cellz_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_cellz, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_initialise_chunk_kernel_cellz_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_initialise_chunk_kernel_cellz, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_initialise_chunk_kernel_cellz_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_cellz, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_cellz<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
