...
int size2 ){
  ...
  arg0 += idx_x * 0*1 + idx_y * 1*1 * xdim0_initialise_chunk_kernel_y + idx_z * 0*1 * xdim0_initialise_chunk_kernel_y * ydim0_initialise_chunk_kernel_y;
  arg1 += idx_x * 0*1 + idx_y * 1*1 * xdim1_initialise_chunk_kernel_y + idx_z * 0*1 * xdim1_initialise_chunk_kernel_y * ydim1_initialise_chunk_kernel_y;
  arg2 += idx_x * 0*1 + idx_y * 1*1 * xdim2_initialise_chunk_kernel_y + idx_z * 0*1 * xdim2_initialise_chunk_kernel_y * ydim2_initialise_chunk_kernel_y;
...
void ops_par_loop_initialise_chunk_kernel_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_y_h || ydim0 != ydim0_initialise_chunk_kernel_y_h || xdim1 != xdim1_initialise_chunk_kernel_y_h || ydim1 != ydim1_initialise_chunk_kernel_y_h || xdim2 != xdim2_initialise_chunk_kernel_y_h || ydim2 != ydim2_initialise_chunk_kernel_y_h) {
    cudaMemcpyToSymbolAsync( xdim0_initialise_chunk_kernel_y, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_initialise_chunk_kernel_y_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_y, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_initialise_chunk_kernel_y_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_initialise_chunk_kernel_y, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_initialise_chunk_kernel_y_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_y, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_initialise_chunk_kernel_y_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_initialise_chunk_kernel_y, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_initialise_chunk_kernel_y_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_y, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_y<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (int *)p_a[1],
