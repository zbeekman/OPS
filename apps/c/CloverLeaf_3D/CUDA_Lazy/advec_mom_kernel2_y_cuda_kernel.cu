...
void ops_par_loop_advec_mom_kernel2_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel2_y_h || ydim0 != ydim0_advec_mom_kernel2_y_h || xdim1 != xdim1_advec_mom_kernel2_y_h || ydim1 != ydim1_advec_mom_kernel2_y_h || xdim2 != xdim2_advec_mom_kernel2_y_h || ydim2 != ydim2_advec_mom_kernel2_y_h || xdim3 != xdim3_advec_mom_kernel2_y_h || ydim3 != ydim3_advec_mom_kernel2_y_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel2_y, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel2_y, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel2_y, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel2_y, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
