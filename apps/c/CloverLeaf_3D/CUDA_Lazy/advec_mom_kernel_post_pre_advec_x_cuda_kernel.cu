...
__constant__ int ydim0_advec_mom_kernel_post_pre_advec_x;
...
__constant__ int ydim1_advec_mom_kernel_post_pre_advec_x;
...
__constant__ int ydim2_advec_mom_kernel_post_pre_advec_x;
...
__constant__ int ydim3_advec_mom_kernel_post_pre_advec_x;
...
inline void advec_mom_kernel_post_pre_advec_x_gpu( double *node_mass_post, const double *post_vol,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel_post_pre_advec_x + idx_z * 1*1 * xdim0_advec_mom_kernel_post_pre_advec_x * ydim0_advec_mom_kernel_post_pre_advec_x;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel_post_pre_advec_x + idx_z * 1*1 * xdim1_advec_mom_kernel_post_pre_advec_x * ydim1_advec_mom_kernel_post_pre_advec_x;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_mom_kernel_post_pre_advec_x + idx_z * 1*1 * xdim2_advec_mom_kernel_post_pre_advec_x * ydim2_advec_mom_kernel_post_pre_advec_x;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_mom_kernel_post_pre_advec_x + idx_z * 1*1 * xdim3_advec_mom_kernel_post_pre_advec_x * ydim3_advec_mom_kernel_post_pre_advec_x;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_mom_kernel_post_pre_advec_x + idx_z * 1*1 * xdim4_advec_mom_kernel_post_pre_advec_x * ydim4_advec_mom_kernel_post_pre_advec_x;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_mom_kernel_post_pre_advec_x_gpu(arg0, arg1, arg2, arg3,
                   arg4);
  }
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_post_pre_advec_x_h || ydim0 != ydim0_advec_mom_kernel_post_pre_advec_x_h || xdim1 != xdim1_advec_mom_kernel_post_pre_advec_x_h || ydim1 != ydim1_advec_mom_kernel_post_pre_advec_x_h || xdim2 != xdim2_advec_mom_kernel_post_pre_advec_x_h || ydim2 != ydim2_advec_mom_kernel_post_pre_advec_x_h || xdim3 != xdim3_advec_mom_kernel_post_pre_advec_x_h || ydim3 != ydim3_advec_mom_kernel_post_pre_advec_x_h || xdim4 != xdim4_advec_mom_kernel_post_pre_advec_x_h || ydim4 != ydim4_advec_mom_kernel_post_pre_advec_x_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel_post_pre_advec_x, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_mom_kernel_post_pre_advec_x_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_post_pre_advec_x, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_mom_kernel_post_pre_advec_x_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel_post_pre_advec_x, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_mom_kernel_post_pre_advec_x_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_post_pre_advec_x, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_mom_kernel_post_pre_advec_x_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel_post_pre_advec_x, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_mom_kernel_post_pre_advec_x_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel_post_pre_advec_x, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_mom_kernel_post_pre_advec_x_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel_post_pre_advec_x, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_mom_kernel_post_pre_advec_x_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel_post_pre_advec_x, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_mom_kernel_post_pre_advec_x_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_mom_kernel_post_pre_advec_x, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_mom_kernel_post_pre_advec_x_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel_post_pre_advec_x, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel_post_pre_advec_x<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
