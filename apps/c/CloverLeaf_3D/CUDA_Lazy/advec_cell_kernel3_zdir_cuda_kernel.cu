...
void ops_par_loop_advec_cell_kernel3_zdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel3_zdir_h || ydim0 != ydim0_advec_cell_kernel3_zdir_h || xdim1 != xdim1_advec_cell_kernel3_zdir_h || ydim1 != ydim1_advec_cell_kernel3_zdir_h || xdim2 != xdim2_advec_cell_kernel3_zdir_h || ydim2 != ydim2_advec_cell_kernel3_zdir_h || xdim3 != xdim3_advec_cell_kernel3_zdir_h || ydim3 != ydim3_advec_cell_kernel3_zdir_h || xdim4 != xdim4_advec_cell_kernel3_zdir_h || ydim4 != ydim4_advec_cell_kernel3_zdir_h || xdim5 != xdim5_advec_cell_kernel3_zdir_h || ydim5 != ydim5_advec_cell_kernel3_zdir_h || xdim6 != xdim6_advec_cell_kernel3_zdir_h || ydim6 != ydim6_advec_cell_kernel3_zdir_h || xdim7 != xdim7_advec_cell_kernel3_zdir_h || ydim7 != ydim7_advec_cell_kernel3_zdir_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_cell_kernel3_zdir, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_cell_kernel3_zdir_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel3_zdir, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_cell_kernel3_zdir_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_cell_kernel3_zdir, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_cell_kernel3_zdir_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel3_zdir, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_cell_kernel3_zdir_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_cell_kernel3_zdir, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_cell_kernel3_zdir_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel3_zdir, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_cell_kernel3_zdir_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_cell_kernel3_zdir, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_cell_kernel3_zdir_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel3_zdir, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_cell_kernel3_zdir_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_cell_kernel3_zdir, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_cell_kernel3_zdir_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_cell_kernel3_zdir, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_advec_cell_kernel3_zdir_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_advec_cell_kernel3_zdir, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_advec_cell_kernel3_zdir_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_advec_cell_kernel3_zdir, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim5_advec_cell_kernel3_zdir_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_advec_cell_kernel3_zdir, &xdim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim6_advec_cell_kernel3_zdir_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_advec_cell_kernel3_zdir, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim6_advec_cell_kernel3_zdir_h = ydim6;
    cudaMemcpyToSymbolAsync( xdim7_advec_cell_kernel3_zdir, &xdim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim7_advec_cell_kernel3_zdir_h = xdim7;
    cudaMemcpyToSymbolAsync( ydim7_advec_cell_kernel3_zdir, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_cell_kernel3_zdir<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
