...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_flux_calc_kernely + idx_z * 1*1 * xdim0_flux_calc_kernely * ydim0_flux_calc_kernely;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_flux_calc_kernely + idx_z * 1*1 * xdim1_flux_calc_kernely * ydim1_flux_calc_kernely;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_flux_calc_kernely + idx_z * 1*1 * xdim2_flux_calc_kernely * ydim2_flux_calc_kernely;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_flux_calc_kernely + idx_z * 1*1 * xdim3_flux_calc_kernely * ydim3_flux_calc_kernely;
...
void ops_par_loop_flux_calc_kernely_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_flux_calc_kernely_h || ydim0 != ydim0_flux_calc_kernely_h || xdim1 != xdim1_flux_calc_kernely_h || ydim1 != ydim1_flux_calc_kernely_h || xdim2 != xdim2_flux_calc_kernely_h || ydim2 != ydim2_flux_calc_kernely_h || xdim3 != xdim3_flux_calc_kernely_h || ydim3 != ydim3_flux_calc_kernely_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_flux_calc_kernely, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_flux_calc_kernely, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_flux_calc_kernely, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_flux_calc_kernely, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
