...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 0*1 * xdim0_calc_dt_kernel + idx_z * 0*1 * xdim0_calc_dt_kernel * ydim0_calc_dt_kernel;
  arg1 += idx_x * 0*1 + idx_y * 1*1 * xdim1_calc_dt_kernel + idx_z * 0*1 * xdim1_calc_dt_kernel * ydim1_calc_dt_kernel;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_calc_dt_kernel + idx_z * 1*1 * xdim2_calc_dt_kernel * ydim2_calc_dt_kernel;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_calc_dt_kernel + idx_z * 1*1 * xdim3_calc_dt_kernel * ydim3_calc_dt_kernel;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_calc_dt_kernel + idx_z * 1*1 * xdim4_calc_dt_kernel * ydim4_calc_dt_kernel;
  arg5 += idx_x * 1*1 + idx_y * 1*1 * xdim5_calc_dt_kernel + idx_z * 1*1 * xdim5_calc_dt_kernel * ydim5_calc_dt_kernel;
  arg6 += idx_x * 1*1 + idx_y * 1*1 * xdim6_calc_dt_kernel + idx_z * 1*1 * xdim6_calc_dt_kernel * ydim6_calc_dt_kernel;
  arg7 += idx_x * 1*1 + idx_y * 1*1 * xdim7_calc_dt_kernel + idx_z * 1*1 * xdim7_calc_dt_kernel * ydim7_calc_dt_kernel;
  arg8 += idx_x * 1*1 + idx_y * 1*1 * xdim8_calc_dt_kernel + idx_z * 1*1 * xdim8_calc_dt_kernel * ydim8_calc_dt_kernel;
  arg9 += idx_x * 1*1 + idx_y * 1*1 * xdim9_calc_dt_kernel + idx_z * 1*1 * xdim9_calc_dt_kernel * ydim9_calc_dt_kernel;
  arg10 += idx_x * 1*1 + idx_y * 1*1 * xdim10_calc_dt_kernel + idx_z * 1*1 * xdim10_calc_dt_kernel * ydim10_calc_dt_kernel;
  arg11 += idx_x * 0*1 + idx_y * 0*1 * xdim11_calc_dt_kernel + idx_z * 1*1 * xdim11_calc_dt_kernel * ydim11_calc_dt_kernel;
  arg12 += idx_x * 1*1 + idx_y * 1*1 * xdim12_calc_dt_kernel + idx_z * 1*1 * xdim12_calc_dt_kernel * ydim12_calc_dt_kernel;
  arg13 += idx_x * 1*1 + idx_y * 1*1 * xdim13_calc_dt_kernel + idx_z * 1*1 * xdim13_calc_dt_kernel * ydim13_calc_dt_kernel;
...
void ops_par_loop_calc_dt_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_calc_dt_kernel_h || ydim0 != ydim0_calc_dt_kernel_h || xdim1 != xdim1_calc_dt_kernel_h || ydim1 != ydim1_calc_dt_kernel_h || xdim2 != xdim2_calc_dt_kernel_h || ydim2 != ydim2_calc_dt_kernel_h || xdim3 != xdim3_calc_dt_kernel_h || ydim3 != ydim3_calc_dt_kernel_h || xdim4 != xdim4_calc_dt_kernel_h || ydim4 != ydim4_calc_dt_kernel_h || xdim5 != xdim5_calc_dt_kernel_h || ydim5 != ydim5_calc_dt_kernel_h || xdim6 != xdim6_calc_dt_kernel_h || ydim6 != ydim6_calc_dt_kernel_h || xdim7 != xdim7_calc_dt_kernel_h || ydim7 != ydim7_calc_dt_kernel_h || xdim8 != xdim8_calc_dt_kernel_h || ydim8 != ydim8_calc_dt_kernel_h || xdim9 != xdim9_calc_dt_kernel_h || ydim9 != ydim9_calc_dt_kernel_h || xdim10 != xdim10_calc_dt_kernel_h || ydim10 != ydim10_calc_dt_kernel_h || xdim11 != xdim11_calc_dt_kernel_h || ydim11 != ydim11_calc_dt_kernel_h || xdim12 != xdim12_calc_dt_kernel_h || ydim12 != ydim12_calc_dt_kernel_h || xdim13 != xdim13_calc_dt_kernel_h || ydim13 != ydim13_calc_dt_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_calc_dt_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_calc_dt_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_calc_dt_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_calc_dt_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_calc_dt_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_calc_dt_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_calc_dt_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_calc_dt_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_calc_dt_kernel, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_calc_dt_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_calc_dt_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_calc_dt_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_calc_dt_kernel, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_calc_dt_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_calc_dt_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_calc_dt_kernel_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_calc_dt_kernel, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_calc_dt_kernel_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_calc_dt_kernel, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_calc_dt_kernel_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_calc_dt_kernel, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_calc_dt_kernel_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_calc_dt_kernel, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim5_calc_dt_kernel_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_calc_dt_kernel, &xdim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim6_calc_dt_kernel_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_calc_dt_kernel, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim6_calc_dt_kernel_h = ydim6;
    cudaMemcpyToSymbolAsync( xdim7_calc_dt_kernel, &xdim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim7_calc_dt_kernel_h = xdim7;
    cudaMemcpyToSymbolAsync( ydim7_calc_dt_kernel, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim7_calc_dt_kernel_h = ydim7;
    cudaMemcpyToSymbolAsync( xdim8_calc_dt_kernel, &xdim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim8_calc_dt_kernel_h = xdim8;
    cudaMemcpyToSymbolAsync( ydim8_calc_dt_kernel, &ydim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim8_calc_dt_kernel_h = ydim8;
    cudaMemcpyToSymbolAsync( xdim9_calc_dt_kernel, &xdim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim9_calc_dt_kernel_h = xdim9;
    cudaMemcpyToSymbolAsync( ydim9_calc_dt_kernel, &ydim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim9_calc_dt_kernel_h = ydim9;
    cudaMemcpyToSymbolAsync( xdim10_calc_dt_kernel, &xdim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim10_calc_dt_kernel_h = xdim10;
    cudaMemcpyToSymbolAsync( ydim10_calc_dt_kernel, &ydim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim10_calc_dt_kernel_h = ydim10;
    cudaMemcpyToSymbolAsync( xdim11_calc_dt_kernel, &xdim11, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim11_calc_dt_kernel_h = xdim11;
    cudaMemcpyToSymbolAsync( ydim11_calc_dt_kernel, &ydim11, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim11_calc_dt_kernel_h = ydim11;
    cudaMemcpyToSymbolAsync( xdim12_calc_dt_kernel, &xdim12, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim12_calc_dt_kernel_h = xdim12;
    cudaMemcpyToSymbolAsync( ydim12_calc_dt_kernel, &ydim12, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim12_calc_dt_kernel_h = ydim12;
    cudaMemcpyToSymbolAsync( xdim13_calc_dt_kernel, &xdim13, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim13_calc_dt_kernel_h = xdim13;
    cudaMemcpyToSymbolAsync( ydim13_calc_dt_kernel, &ydim13, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_calc_dt_kernel<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
