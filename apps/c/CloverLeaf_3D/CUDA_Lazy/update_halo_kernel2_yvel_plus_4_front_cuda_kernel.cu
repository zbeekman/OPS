...
inline void update_halo_kernel2_yvel_plus_4_front_gpu(double *yvel0, double *yvel1, const int* fields)
{
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel2_yvel_plus_4_front + idx_z * 1*1 * xdim0_update_halo_kernel2_yvel_plus_4_front * ydim0_update_halo_kernel2_yvel_plus_4_front;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel2_yvel_plus_4_front + idx_z * 1*1 * xdim1_update_halo_kernel2_yvel_plus_4_front * ydim1_update_halo_kernel2_yvel_plus_4_front;
...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_front_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_4_front_h || ydim0 != ydim0_update_halo_kernel2_yvel_plus_4_front_h || xdim1 != xdim1_update_halo_kernel2_yvel_plus_4_front_h || ydim1 != ydim1_update_halo_kernel2_yvel_plus_4_front_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_yvel_plus_4_front, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_yvel_plus_4_front_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel2_yvel_plus_4_front, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel2_yvel_plus_4_front_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_yvel_plus_4_front, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel2_yvel_plus_4_front_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel2_yvel_plus_4_front, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_yvel_plus_4_front<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
