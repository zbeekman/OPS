...
void ops_par_loop_update_halo_kernel1_l1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel1_l1_h || ydim0 != ydim0_update_halo_kernel1_l1_h || xdim1 != xdim1_update_halo_kernel1_l1_h || ydim1 != ydim1_update_halo_kernel1_l1_h || xdim2 != xdim2_update_halo_kernel1_l1_h || ydim2 != ydim2_update_halo_kernel1_l1_h || xdim3 != xdim3_update_halo_kernel1_l1_h || ydim3 != ydim3_update_halo_kernel1_l1_h || xdim4 != xdim4_update_halo_kernel1_l1_h || ydim4 != ydim4_update_halo_kernel1_l1_h || xdim5 != xdim5_update_halo_kernel1_l1_h || ydim5 != ydim5_update_halo_kernel1_l1_h || xdim6 != xdim6_update_halo_kernel1_l1_h || ydim6 != ydim6_update_halo_kernel1_l1_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel1_l1, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel1_l1, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_update_halo_kernel1_l1, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_update_halo_kernel1_l1, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim4_update_halo_kernel1_l1, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim5_update_halo_kernel1_l1, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim6_update_halo_kernel1_l1, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
