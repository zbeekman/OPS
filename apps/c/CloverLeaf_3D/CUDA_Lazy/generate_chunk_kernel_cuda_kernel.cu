...
void ops_par_loop_generate_chunk_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_generate_chunk_kernel_h || ydim0 != ydim0_generate_chunk_kernel_h || xdim1 != xdim1_generate_chunk_kernel_h || ydim1 != ydim1_generate_chunk_kernel_h || xdim2 != xdim2_generate_chunk_kernel_h || ydim2 != ydim2_generate_chunk_kernel_h || xdim3 != xdim3_generate_chunk_kernel_h || ydim3 != ydim3_generate_chunk_kernel_h || xdim4 != xdim4_generate_chunk_kernel_h || ydim4 != ydim4_generate_chunk_kernel_h || xdim5 != xdim5_generate_chunk_kernel_h || ydim5 != ydim5_generate_chunk_kernel_h || xdim6 != xdim6_generate_chunk_kernel_h || ydim6 != ydim6_generate_chunk_kernel_h || xdim7 != xdim7_generate_chunk_kernel_h || ydim7 != ydim7_generate_chunk_kernel_h || xdim8 != xdim8_generate_chunk_kernel_h || ydim8 != ydim8_generate_chunk_kernel_h || xdim9 != xdim9_generate_chunk_kernel_h || ydim9 != ydim9_generate_chunk_kernel_h || xdim10 != xdim10_generate_chunk_kernel_h || ydim10 != ydim10_generate_chunk_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_generate_chunk_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_generate_chunk_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_generate_chunk_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_generate_chunk_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_generate_chunk_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_generate_chunk_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_generate_chunk_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_generate_chunk_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_generate_chunk_kernel, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_generate_chunk_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_generate_chunk_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_generate_chunk_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_generate_chunk_kernel, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_generate_chunk_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_generate_chunk_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_generate_chunk_kernel_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_generate_chunk_kernel, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_generate_chunk_kernel_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_generate_chunk_kernel, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_generate_chunk_kernel_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_generate_chunk_kernel, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_generate_chunk_kernel_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_generate_chunk_kernel, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim5_generate_chunk_kernel_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_generate_chunk_kernel, &xdim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim6_generate_chunk_kernel_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_generate_chunk_kernel, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim6_generate_chunk_kernel_h = ydim6;
    cudaMemcpyToSymbolAsync( xdim7_generate_chunk_kernel, &xdim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim7_generate_chunk_kernel_h = xdim7;
    cudaMemcpyToSymbolAsync( ydim7_generate_chunk_kernel, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim7_generate_chunk_kernel_h = ydim7;
    cudaMemcpyToSymbolAsync( xdim8_generate_chunk_kernel, &xdim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim8_generate_chunk_kernel_h = xdim8;
    cudaMemcpyToSymbolAsync( ydim8_generate_chunk_kernel, &ydim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim8_generate_chunk_kernel_h = ydim8;
    cudaMemcpyToSymbolAsync( xdim9_generate_chunk_kernel, &xdim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim9_generate_chunk_kernel_h = xdim9;
    cudaMemcpyToSymbolAsync( ydim9_generate_chunk_kernel, &ydim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim9_generate_chunk_kernel_h = ydim9;
    cudaMemcpyToSymbolAsync( xdim10_generate_chunk_kernel, &xdim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim10_generate_chunk_kernel_h = xdim10;
    cudaMemcpyToSymbolAsync( ydim10_generate_chunk_kernel, &ydim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_generate_chunk_kernel<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
