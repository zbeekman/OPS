...
inline void advec_cell_kernel2_xdir_gpu( double *pre_vol, double *post_vol, const double *volume,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim0_advec_cell_kernel2_xdir * ydim0_advec_cell_kernel2_xdir;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim1_advec_cell_kernel2_xdir * ydim1_advec_cell_kernel2_xdir;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim2_advec_cell_kernel2_xdir * ydim2_advec_cell_kernel2_xdir;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim3_advec_cell_kernel2_xdir * ydim3_advec_cell_kernel2_xdir;
...
void ops_par_loop_advec_cell_kernel2_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel2_xdir_h || ydim0 != ydim0_advec_cell_kernel2_xdir_h || xdim1 != xdim1_advec_cell_kernel2_xdir_h || ydim1 != ydim1_advec_cell_kernel2_xdir_h || xdim2 != xdim2_advec_cell_kernel2_xdir_h || ydim2 != ydim2_advec_cell_kernel2_xdir_h || xdim3 != xdim3_advec_cell_kernel2_xdir_h || ydim3 != ydim3_advec_cell_kernel2_xdir_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_cell_kernel2_xdir, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_cell_kernel2_xdir_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel2_xdir, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_cell_kernel2_xdir_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_cell_kernel2_xdir, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_cell_kernel2_xdir_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel2_xdir, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_cell_kernel2_xdir_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_cell_kernel2_xdir, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_cell_kernel2_xdir_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel2_xdir, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_cell_kernel2_xdir_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_cell_kernel2_xdir, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_cell_kernel2_xdir_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel2_xdir, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_cell_kernel2_xdir<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
