...
__constant__ int ydim0_initialise_chunk_kernel_xx;
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 0*1 * xdim0_initialise_chunk_kernel_xx + idx_z * 0*1 * xdim0_initialise_chunk_kernel_xx * ydim0_initialise_chunk_kernel_xx;
...
void ops_par_loop_initialise_chunk_kernel_xx_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_xx_h || ydim0 != ydim0_initialise_chunk_kernel_xx_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_xx, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_initialise_chunk_kernel_xx<<<grid, tblock, 0, stream >>> (  (int *)p_a[0], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
