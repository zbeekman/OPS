...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_field_summary_kernel + idx_z * 1*1 * xdim0_field_summary_kernel * ydim0_field_summary_kernel;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_field_summary_kernel + idx_z * 1*1 * xdim1_field_summary_kernel * ydim1_field_summary_kernel;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_field_summary_kernel + idx_z * 1*1 * xdim2_field_summary_kernel * ydim2_field_summary_kernel;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_field_summary_kernel + idx_z * 1*1 * xdim3_field_summary_kernel * ydim3_field_summary_kernel;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_field_summary_kernel + idx_z * 1*1 * xdim4_field_summary_kernel * ydim4_field_summary_kernel;
  arg5 += idx_x * 1*1 + idx_y * 1*1 * xdim5_field_summary_kernel + idx_z * 1*1 * xdim5_field_summary_kernel * ydim5_field_summary_kernel;
  arg6 += idx_x * 1*1 + idx_y * 1*1 * xdim6_field_summary_kernel + idx_z * 1*1 * xdim6_field_summary_kernel * ydim6_field_summary_kernel;
...
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_field_summary_kernel_h || ydim0 != ydim0_field_summary_kernel_h || xdim1 != xdim1_field_summary_kernel_h || ydim1 != ydim1_field_summary_kernel_h || xdim2 != xdim2_field_summary_kernel_h || ydim2 != ydim2_field_summary_kernel_h || xdim3 != xdim3_field_summary_kernel_h || ydim3 != ydim3_field_summary_kernel_h || xdim4 != xdim4_field_summary_kernel_h || ydim4 != ydim4_field_summary_kernel_h || xdim5 != xdim5_field_summary_kernel_h || ydim5 != ydim5_field_summary_kernel_h || xdim6 != xdim6_field_summary_kernel_h || ydim6 != ydim6_field_summary_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_field_summary_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_field_summary_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_field_summary_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_field_summary_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_field_summary_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_field_summary_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_field_summary_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_field_summary_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_field_summary_kernel, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_field_summary_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_field_summary_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_field_summary_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_field_summary_kernel, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_field_summary_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_field_summary_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_field_summary_kernel_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_field_summary_kernel, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_field_summary_kernel_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_field_summary_kernel, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_field_summary_kernel_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_field_summary_kernel, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_field_summary_kernel_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_field_summary_kernel, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim5_field_summary_kernel_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_field_summary_kernel, &xdim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim6_field_summary_kernel_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_field_summary_kernel, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_field_summary_kernel<<<grid, tblock, nshared, stream >>> (  (double *)p_a[0], (double *)p_a[1],
