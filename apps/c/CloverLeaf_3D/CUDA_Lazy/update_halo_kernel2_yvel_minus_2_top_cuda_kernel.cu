...
inline void update_halo_kernel2_yvel_minus_2_top_gpu(double *yvel0, double *yvel1, const int* fields)
{
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel2_yvel_minus_2_top + idx_z * 1*1 * xdim0_update_halo_kernel2_yvel_minus_2_top * ydim0_update_halo_kernel2_yvel_minus_2_top;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel2_yvel_minus_2_top + idx_z * 1*1 * xdim1_update_halo_kernel2_yvel_minus_2_top * ydim1_update_halo_kernel2_yvel_minus_2_top;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_yvel_minus_2_top_gpu(arg0, arg1, &arg2);
  }
...
// host stub function
// host stub function
void ops_par_loop_update_halo_kernel2_yvel_minus_2_top_execute(ops_kernel_descriptor *desc) {
  #ifdef OPS_MPI
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_minus_2_top_h || ydim0 != ydim0_update_halo_kernel2_yvel_minus_2_top_h || xdim1 != xdim1_update_halo_kernel2_yvel_minus_2_top_h || ydim1 != ydim1_update_halo_kernel2_yvel_minus_2_top_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_yvel_minus_2_top, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_yvel_minus_2_top_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel2_yvel_minus_2_top, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel2_yvel_minus_2_top_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_yvel_minus_2_top, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel2_yvel_minus_2_top_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel2_yvel_minus_2_top, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_yvel_minus_2_top<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
