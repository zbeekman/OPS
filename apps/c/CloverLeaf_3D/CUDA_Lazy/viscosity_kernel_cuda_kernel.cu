...
void ops_par_loop_viscosity_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_viscosity_kernel_h || ydim0 != ydim0_viscosity_kernel_h || xdim1 != xdim1_viscosity_kernel_h || ydim1 != ydim1_viscosity_kernel_h || xdim2 != xdim2_viscosity_kernel_h || ydim2 != ydim2_viscosity_kernel_h || xdim3 != xdim3_viscosity_kernel_h || ydim3 != ydim3_viscosity_kernel_h || xdim4 != xdim4_viscosity_kernel_h || ydim4 != ydim4_viscosity_kernel_h || xdim5 != xdim5_viscosity_kernel_h || ydim5 != ydim5_viscosity_kernel_h || xdim6 != xdim6_viscosity_kernel_h || ydim6 != ydim6_viscosity_kernel_h || xdim7 != xdim7_viscosity_kernel_h || ydim7 != ydim7_viscosity_kernel_h || xdim8 != xdim8_viscosity_kernel_h || ydim8 != ydim8_viscosity_kernel_h || xdim9 != xdim9_viscosity_kernel_h || ydim9 != ydim9_viscosity_kernel_h || xdim10 != xdim10_viscosity_kernel_h || ydim10 != ydim10_viscosity_kernel_h || xdim11 != xdim11_viscosity_kernel_h || ydim11 != ydim11_viscosity_kernel_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_viscosity_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_viscosity_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_viscosity_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_viscosity_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim4_viscosity_kernel, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim5_viscosity_kernel, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim6_viscosity_kernel, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim6_viscosity_kernel_h = ydim6;
    cudaMemcpyToSymbolAsync( xdim7_viscosity_kernel, &xdim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim7_viscosity_kernel_h = xdim7;
    cudaMemcpyToSymbolAsync( ydim7_viscosity_kernel, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim7_viscosity_kernel_h = ydim7;
    cudaMemcpyToSymbolAsync( xdim8_viscosity_kernel, &xdim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim8_viscosity_kernel_h = xdim8;
    cudaMemcpyToSymbolAsync( ydim8_viscosity_kernel, &ydim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim8_viscosity_kernel_h = ydim8;
    cudaMemcpyToSymbolAsync( xdim9_viscosity_kernel, &xdim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim9_viscosity_kernel_h = xdim9;
    cudaMemcpyToSymbolAsync( ydim9_viscosity_kernel, &ydim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim9_viscosity_kernel_h = ydim9;
    cudaMemcpyToSymbolAsync( xdim10_viscosity_kernel, &xdim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim10_viscosity_kernel_h = xdim10;
    cudaMemcpyToSymbolAsync( ydim10_viscosity_kernel, &ydim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim10_viscosity_kernel_h = ydim10;
    cudaMemcpyToSymbolAsync( xdim11_viscosity_kernel, &xdim11, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim11_viscosity_kernel_h = xdim11;
    cudaMemcpyToSymbolAsync( ydim11_viscosity_kernel, &ydim11, sizeof(int),0,cudaMemcpyHostToDevice,stream );
