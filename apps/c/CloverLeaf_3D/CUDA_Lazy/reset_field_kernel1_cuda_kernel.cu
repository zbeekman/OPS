...
void ops_par_loop_reset_field_kernel1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_reset_field_kernel1_h || ydim0 != ydim0_reset_field_kernel1_h || xdim1 != xdim1_reset_field_kernel1_h || ydim1 != ydim1_reset_field_kernel1_h || xdim2 != xdim2_reset_field_kernel1_h || ydim2 != ydim2_reset_field_kernel1_h || xdim3 != xdim3_reset_field_kernel1_h || ydim3 != ydim3_reset_field_kernel1_h) {
    cudaMemcpyToSymbolAsync( xdim0_reset_field_kernel1, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_reset_field_kernel1_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_reset_field_kernel1, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_reset_field_kernel1_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_reset_field_kernel1, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_reset_field_kernel1_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_reset_field_kernel1, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_reset_field_kernel1_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_reset_field_kernel1, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_reset_field_kernel1_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_reset_field_kernel1, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_reset_field_kernel1_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_reset_field_kernel1, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_reset_field_kernel1_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_reset_field_kernel1, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_reset_field_kernel1<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
