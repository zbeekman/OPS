...
inline void update_halo_kernel5_plus_2_b_gpu(double *vol_flux_z, double *mass_flux_z, const int* fields) {
  if((*fields) & FIELD_VOL_FLUX_Z) vol_flux_z[OPS_ACC0(0,0,0)] = vol_flux_z[OPS_ACC0(0,-2,0)];
  if((*fields) & FIELD_MASS_FLUX_Z) mass_flux_z[OPS_ACC1(0,0,0)] = mass_flux_z[OPS_ACC1(0,-2,0)];
}
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel5_plus_2_b + idx_z * 1*1 * xdim0_update_halo_kernel5_plus_2_b * ydim0_update_halo_kernel5_plus_2_b;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel5_plus_2_b + idx_z * 1*1 * xdim1_update_halo_kernel5_plus_2_b * ydim1_update_halo_kernel5_plus_2_b;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel5_plus_2_b_gpu(arg0, arg1, &arg2);
  }
...
// host stub function
// host stub function
void ops_par_loop_update_halo_kernel5_plus_2_b_execute(ops_kernel_descriptor *desc) {
  #ifdef OPS_MPI
  ...
  if (xdim0 != xdim0_update_halo_kernel5_plus_2_b_h || ydim0 != ydim0_update_halo_kernel5_plus_2_b_h || xdim1 != xdim1_update_halo_kernel5_plus_2_b_h || ydim1 != ydim1_update_halo_kernel5_plus_2_b_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel5_plus_2_b, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel5_plus_2_b_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel5_plus_2_b, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel5_plus_2_b_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel5_plus_2_b, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel5_plus_2_b_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel5_plus_2_b, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel5_plus_2_b<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
...
void ops_par_loop_update_halo_kernel5_plus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  desc->function = ops_par_loop_update_halo_kernel5_plus_2_b_execute;
  if (OPS_diags > 1) {
    ops_timing_realloc(132,"update_halo_kernel5_plus_2_b");
  }
