...
inline void advec_cell_kernel4_xdir_gpu( double *density1, double *energy1,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_cell_kernel4_xdir_gpu(arg0, arg1, arg2, arg3,
...
void ops_par_loop_advec_cell_kernel4_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel4_xdir_h || ydim0 != ydim0_advec_cell_kernel4_xdir_h || xdim1 != xdim1_advec_cell_kernel4_xdir_h || ydim1 != ydim1_advec_cell_kernel4_xdir_h || xdim2 != xdim2_advec_cell_kernel4_xdir_h || ydim2 != ydim2_advec_cell_kernel4_xdir_h || xdim3 != xdim3_advec_cell_kernel4_xdir_h || ydim3 != ydim3_advec_cell_kernel4_xdir_h || xdim4 != xdim4_advec_cell_kernel4_xdir_h || ydim4 != ydim4_advec_cell_kernel4_xdir_h || xdim5 != xdim5_advec_cell_kernel4_xdir_h || ydim5 != ydim5_advec_cell_kernel4_xdir_h || xdim6 != xdim6_advec_cell_kernel4_xdir_h || ydim6 != ydim6_advec_cell_kernel4_xdir_h || xdim7 != xdim7_advec_cell_kernel4_xdir_h || ydim7 != ydim7_advec_cell_kernel4_xdir_h || xdim8 != xdim8_advec_cell_kernel4_xdir_h || ydim8 != ydim8_advec_cell_kernel4_xdir_h || xdim9 != xdim9_advec_cell_kernel4_xdir_h || ydim9 != ydim9_advec_cell_kernel4_xdir_h || xdim10 != xdim10_advec_cell_kernel4_xdir_h || ydim10 != ydim10_advec_cell_kernel4_xdir_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_cell_kernel4_xdir, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_cell_kernel4_xdir_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel4_xdir, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_cell_kernel4_xdir_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_cell_kernel4_xdir, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_cell_kernel4_xdir_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel4_xdir, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_cell_kernel4_xdir_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_cell_kernel4_xdir, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_cell_kernel4_xdir_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel4_xdir, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_cell_kernel4_xdir_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_cell_kernel4_xdir, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_cell_kernel4_xdir_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel4_xdir, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_cell_kernel4_xdir_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_cell_kernel4_xdir, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_cell_kernel4_xdir_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_cell_kernel4_xdir, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_advec_cell_kernel4_xdir_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_advec_cell_kernel4_xdir, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_advec_cell_kernel4_xdir_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_advec_cell_kernel4_xdir, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim5_advec_cell_kernel4_xdir_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_advec_cell_kernel4_xdir, &xdim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim6_advec_cell_kernel4_xdir_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_advec_cell_kernel4_xdir, &ydim6, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim6_advec_cell_kernel4_xdir_h = ydim6;
    cudaMemcpyToSymbolAsync( xdim7_advec_cell_kernel4_xdir, &xdim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim7_advec_cell_kernel4_xdir_h = xdim7;
    cudaMemcpyToSymbolAsync( ydim7_advec_cell_kernel4_xdir, &ydim7, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim7_advec_cell_kernel4_xdir_h = ydim7;
    cudaMemcpyToSymbolAsync( xdim8_advec_cell_kernel4_xdir, &xdim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim8_advec_cell_kernel4_xdir_h = xdim8;
    cudaMemcpyToSymbolAsync( ydim8_advec_cell_kernel4_xdir, &ydim8, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim8_advec_cell_kernel4_xdir_h = ydim8;
    cudaMemcpyToSymbolAsync( xdim9_advec_cell_kernel4_xdir, &xdim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim9_advec_cell_kernel4_xdir_h = xdim9;
    cudaMemcpyToSymbolAsync( ydim9_advec_cell_kernel4_xdir, &ydim9, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim9_advec_cell_kernel4_xdir_h = ydim9;
    cudaMemcpyToSymbolAsync( xdim10_advec_cell_kernel4_xdir, &xdim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim10_advec_cell_kernel4_xdir_h = xdim10;
    cudaMemcpyToSymbolAsync( ydim10_advec_cell_kernel4_xdir, &ydim10, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_cell_kernel4_xdir<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
