...
inline void update_halo_kernel2_xvel_minus_4_left_gpu(double *xvel0, double *xvel1, const int* fields)
{
  if((*fields) & FIELD_XVEL0) xvel0[OPS_ACC0(0,0,0)] = -xvel0[OPS_ACC0(4,0,0)];
  if((*fields) & FIELD_XVEL1) xvel1[OPS_ACC1(0,0,0)] = -xvel1[OPS_ACC1(4,0,0)];
}
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel2_xvel_minus_4_left + idx_z * 1*1 * xdim0_update_halo_kernel2_xvel_minus_4_left * ydim0_update_halo_kernel2_xvel_minus_4_left;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel2_xvel_minus_4_left + idx_z * 1*1 * xdim1_update_halo_kernel2_xvel_minus_4_left * ydim1_update_halo_kernel2_xvel_minus_4_left;
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_left_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_minus_4_left_h || ydim0 != ydim0_update_halo_kernel2_xvel_minus_4_left_h || xdim1 != xdim1_update_halo_kernel2_xvel_minus_4_left_h || ydim1 != ydim1_update_halo_kernel2_xvel_minus_4_left_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_xvel_minus_4_left, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel2_xvel_minus_4_left_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel2_xvel_minus_4_left, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel2_xvel_minus_4_left_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_xvel_minus_4_left, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel2_xvel_minus_4_left_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel2_xvel_minus_4_left, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel2_xvel_minus_4_left<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
