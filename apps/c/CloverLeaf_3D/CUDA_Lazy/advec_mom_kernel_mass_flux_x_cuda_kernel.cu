...
void ops_par_loop_advec_mom_kernel_mass_flux_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_mass_flux_x_h || ydim0 != ydim0_advec_mom_kernel_mass_flux_x_h || xdim1 != xdim1_advec_mom_kernel_mass_flux_x_h || ydim1 != ydim1_advec_mom_kernel_mass_flux_x_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_mass_flux_x, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_mass_flux_x, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_mom_kernel_mass_flux_x<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
