...
inline void update_halo_kernel3_minus_4_a_gpu(double *vol_flux_x, double *mass_flux_x, const int* fields) {
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel3_minus_4_a + idx_z * 1*1 * xdim0_update_halo_kernel3_minus_4_a * ydim0_update_halo_kernel3_minus_4_a;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel3_minus_4_a + idx_z * 1*1 * xdim1_update_halo_kernel3_minus_4_a * ydim1_update_halo_kernel3_minus_4_a;
...
void ops_par_loop_update_halo_kernel3_minus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel3_minus_4_a_h || ydim0 != ydim0_update_halo_kernel3_minus_4_a_h || xdim1 != xdim1_update_halo_kernel3_minus_4_a_h || ydim1 != ydim1_update_halo_kernel3_minus_4_a_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel3_minus_4_a, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_update_halo_kernel3_minus_4_a_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel3_minus_4_a, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_update_halo_kernel3_minus_4_a_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel3_minus_4_a, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_update_halo_kernel3_minus_4_a_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel3_minus_4_a, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_update_halo_kernel3_minus_4_a<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
