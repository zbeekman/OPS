...
__constant__ int ydim0_advec_mom_kernel1_x_nonvector;
...
__constant__ int ydim1_advec_mom_kernel1_x_nonvector;
...
__constant__ int ydim2_advec_mom_kernel1_x_nonvector;
...
__constant__ int ydim3_advec_mom_kernel1_x_nonvector;
...
__constant__ int ydim4_advec_mom_kernel1_x_nonvector;
...
void ops_par_loop_advec_mom_kernel1_x_nonvector_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel1_x_nonvector_h || ydim0 != ydim0_advec_mom_kernel1_x_nonvector_h || xdim1 != xdim1_advec_mom_kernel1_x_nonvector_h || ydim1 != ydim1_advec_mom_kernel1_x_nonvector_h || xdim2 != xdim2_advec_mom_kernel1_x_nonvector_h || ydim2 != ydim2_advec_mom_kernel1_x_nonvector_h || xdim3 != xdim3_advec_mom_kernel1_x_nonvector_h || ydim3 != ydim3_advec_mom_kernel1_x_nonvector_h || xdim4 != xdim4_advec_mom_kernel1_x_nonvector_h || ydim4 != ydim4_advec_mom_kernel1_x_nonvector_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel1_x_nonvector, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel1_x_nonvector, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel1_x_nonvector, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel1_x_nonvector, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel1_x_nonvector, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
