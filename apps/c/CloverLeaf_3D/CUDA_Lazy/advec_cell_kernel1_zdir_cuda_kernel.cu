...
inline void advec_cell_kernel1_zdir_gpu( double *pre_vol, double *post_vol, const double *volume,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim0_advec_cell_kernel1_zdir * ydim0_advec_cell_kernel1_zdir;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim1_advec_cell_kernel1_zdir * ydim1_advec_cell_kernel1_zdir;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim2_advec_cell_kernel1_zdir * ydim2_advec_cell_kernel1_zdir;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim3_advec_cell_kernel1_zdir * ydim3_advec_cell_kernel1_zdir;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim4_advec_cell_kernel1_zdir * ydim4_advec_cell_kernel1_zdir;
  arg5 += idx_x * 1*1 + idx_y * 1*1 * xdim5_advec_cell_kernel1_zdir + idx_z * 1*1 * xdim5_advec_cell_kernel1_zdir * ydim5_advec_cell_kernel1_zdir;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_cell_kernel1_zdir_gpu(arg0, arg1, arg2, arg3,
                   arg4, arg5);
  }
...
void ops_par_loop_advec_cell_kernel1_zdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel1_zdir_h || ydim0 != ydim0_advec_cell_kernel1_zdir_h || xdim1 != xdim1_advec_cell_kernel1_zdir_h || ydim1 != ydim1_advec_cell_kernel1_zdir_h || xdim2 != xdim2_advec_cell_kernel1_zdir_h || ydim2 != ydim2_advec_cell_kernel1_zdir_h || xdim3 != xdim3_advec_cell_kernel1_zdir_h || ydim3 != ydim3_advec_cell_kernel1_zdir_h || xdim4 != xdim4_advec_cell_kernel1_zdir_h || ydim4 != ydim4_advec_cell_kernel1_zdir_h || xdim5 != xdim5_advec_cell_kernel1_zdir_h || ydim5 != ydim5_advec_cell_kernel1_zdir_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_cell_kernel1_zdir, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_advec_cell_kernel1_zdir_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel1_zdir, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_advec_cell_kernel1_zdir_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_cell_kernel1_zdir, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_advec_cell_kernel1_zdir_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel1_zdir, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_advec_cell_kernel1_zdir_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_cell_kernel1_zdir, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_advec_cell_kernel1_zdir_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel1_zdir, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_advec_cell_kernel1_zdir_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_cell_kernel1_zdir, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_advec_cell_kernel1_zdir_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel1_zdir, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_cell_kernel1_zdir_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_cell_kernel1_zdir, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_cell_kernel1_zdir_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_cell_kernel1_zdir, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim4_advec_cell_kernel1_zdir_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_advec_cell_kernel1_zdir, &xdim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim5_advec_cell_kernel1_zdir_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_advec_cell_kernel1_zdir, &ydim5, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_advec_cell_kernel1_zdir<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
