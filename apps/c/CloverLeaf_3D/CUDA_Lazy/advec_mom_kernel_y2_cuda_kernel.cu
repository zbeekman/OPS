...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel_y2 + idx_z * 1*1 * xdim0_advec_mom_kernel_y2 * ydim0_advec_mom_kernel_y2;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel_y2 + idx_z * 1*1 * xdim1_advec_mom_kernel_y2 * ydim1_advec_mom_kernel_y2;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_mom_kernel_y2 + idx_z * 1*1 * xdim2_advec_mom_kernel_y2 * ydim2_advec_mom_kernel_y2;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_mom_kernel_y2 + idx_z * 1*1 * xdim3_advec_mom_kernel_y2 * ydim3_advec_mom_kernel_y2;
  arg4 += idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_mom_kernel_y2 + idx_z * 1*1 * xdim4_advec_mom_kernel_y2 * ydim4_advec_mom_kernel_y2;
...
void ops_par_loop_advec_mom_kernel_y2_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_y2_h || ydim0 != ydim0_advec_mom_kernel_y2_h || xdim1 != xdim1_advec_mom_kernel_y2_h || ydim1 != ydim1_advec_mom_kernel_y2_h || xdim2 != xdim2_advec_mom_kernel_y2_h || ydim2 != ydim2_advec_mom_kernel_y2_h || xdim3 != xdim3_advec_mom_kernel_y2_h || ydim3 != ydim3_advec_mom_kernel_y2_h || xdim4 != xdim4_advec_mom_kernel_y2_h || ydim4 != ydim4_advec_mom_kernel_y2_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_y2, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_y2, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel_y2, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel_y2, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim3_advec_mom_kernel_y2_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_mom_kernel_y2, &xdim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim4_advec_mom_kernel_y2_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel_y2, &ydim4, sizeof(int),0,cudaMemcpyHostToDevice,stream );
