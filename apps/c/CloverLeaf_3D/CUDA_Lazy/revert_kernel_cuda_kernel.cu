...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_revert_kernel + idx_z * 1*1 * xdim0_revert_kernel * ydim0_revert_kernel;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_revert_kernel + idx_z * 1*1 * xdim1_revert_kernel * ydim1_revert_kernel;
  arg2 += idx_x * 1*1 + idx_y * 1*1 * xdim2_revert_kernel + idx_z * 1*1 * xdim2_revert_kernel * ydim2_revert_kernel;
  arg3 += idx_x * 1*1 + idx_y * 1*1 * xdim3_revert_kernel + idx_z * 1*1 * xdim3_revert_kernel * ydim3_revert_kernel;
...
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_revert_kernel_h || ydim0 != ydim0_revert_kernel_h || xdim1 != xdim1_revert_kernel_h || ydim1 != ydim1_revert_kernel_h || xdim2 != xdim2_revert_kernel_h || ydim2 != ydim2_revert_kernel_h || xdim3 != xdim3_revert_kernel_h || ydim3 != ydim3_revert_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_revert_kernel, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_revert_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_revert_kernel, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_revert_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_revert_kernel, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_revert_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_revert_kernel, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_revert_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_revert_kernel, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_revert_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_revert_kernel, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_revert_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_revert_kernel, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_revert_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_revert_kernel, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_revert_kernel<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
