...
void flux_calc_kernelx_gpu( double *vol_flux_x, const double *xarea,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    flux_calc_kernelx_gpu(arg0, arg1, arg2, arg3);
  }
...
void ops_par_loop_flux_calc_kernelx_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_flux_calc_kernelx_h || ydim0 != ydim0_flux_calc_kernelx_h || xdim1 != xdim1_flux_calc_kernelx_h || ydim1 != ydim1_flux_calc_kernelx_h || xdim2 != xdim2_flux_calc_kernelx_h || ydim2 != ydim2_flux_calc_kernelx_h || xdim3 != xdim3_flux_calc_kernelx_h || ydim3 != ydim3_flux_calc_kernelx_h) {
    cudaMemcpyToSymbolAsync( xdim0_flux_calc_kernelx, &xdim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim0_flux_calc_kernelx_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_flux_calc_kernelx, &ydim0, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim0_flux_calc_kernelx_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_flux_calc_kernelx, &xdim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim1_flux_calc_kernelx_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_flux_calc_kernelx, &ydim1, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim1_flux_calc_kernelx_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_flux_calc_kernelx, &xdim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim2_flux_calc_kernelx_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_flux_calc_kernelx, &ydim2, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    ydim2_flux_calc_kernelx_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_flux_calc_kernelx, &xdim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
    xdim3_flux_calc_kernelx_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_flux_calc_kernelx, &ydim3, sizeof(int),0,cudaMemcpyHostToDevice,stream );
  ...
  ops_flux_calc_kernelx<<<grid, tblock, 0, stream >>> (  (double *)p_a[0], (double *)p_a[1],
