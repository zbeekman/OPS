...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel2_yvel_plus_4_front * 1 +           \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel2_yvel_plus_4_front * 1 +           \
...
void update_halo_kernel2_yvel_plus_4_front_c_wrapper(double *restrict yvel0,
