...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel5_plus_4_a * 1 +                    \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel5_plus_4_a * 1 +                    \
...
void update_halo_kernel5_plus_4_a_c_wrapper(double *restrict vol_flux_z,
