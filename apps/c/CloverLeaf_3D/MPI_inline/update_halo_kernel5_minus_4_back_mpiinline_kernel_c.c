...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel5_minus_4_back * 1 +                \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel5_minus_4_back * 1 +                \
...
void update_halo_kernel5_minus_4_back_c_wrapper(double *restrict vol_flux_z,
