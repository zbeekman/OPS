...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel4_plus_2_b * 1 +                    \
   n_z * xdim0_update_halo_kernel4_plus_2_b *                                  \
       ydim0_update_halo_kernel4_plus_2_b * 1 +                                \
   x + xdim0_update_halo_kernel4_plus_2_b * (y) +                              \
   xdim0_update_halo_kernel4_plus_2_b * ydim0_update_halo_kernel4_plus_2_b *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel4_plus_2_b * 1 +                    \
   n_z * xdim1_update_halo_kernel4_plus_2_b *                                  \
       ydim1_update_halo_kernel4_plus_2_b * 1 +                                \
...
void update_halo_kernel4_plus_2_b_c_wrapper(double *restrict vol_flux_y,
