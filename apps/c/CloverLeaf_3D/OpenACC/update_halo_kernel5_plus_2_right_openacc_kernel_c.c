  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        update_halo_kernel5_plus_2_right(  p_a0 + n_x*1*1 + n_y*xdim0_update_halo_kernel5_plus_2_right*1*1 + n_z*xdim0_update_halo_kernel5_plus_2_right*ydim0_update_halo_kernel5_plus_2_right*1,
           p_a1 + n_x*1*1 + n_y*xdim1_update_halo_kernel5_plus_2_right*1*1 + n_z*xdim1_update_halo_kernel5_plus_2_right*ydim1_update_halo_kernel5_plus_2_right*1,
           &p_a2 );
