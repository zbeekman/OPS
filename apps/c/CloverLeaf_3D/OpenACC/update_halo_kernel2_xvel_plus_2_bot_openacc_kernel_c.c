...
inline void update_halo_kernel2_xvel_plus_2_bot(double *xvel0, double *xvel1,
                                                const int *fields) {
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel2_xvel_plus_2_bot(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel2_xvel_plus_2_bot * 1 * 1 +
                n_z * xdim0_update_halo_kernel2_xvel_plus_2_bot *
                    ydim0_update_halo_kernel2_xvel_plus_2_bot * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel2_xvel_plus_2_bot * 1 * 1 +
