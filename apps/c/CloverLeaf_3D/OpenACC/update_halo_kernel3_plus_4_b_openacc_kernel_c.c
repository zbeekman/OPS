...
inline void update_halo_kernel3_plus_4_b(double *vol_flux_x,
                                         double *mass_flux_x,
                                         const int *fields) {
...
void update_halo_kernel3_plus_4_b_c_wrapper(double *p_a0, double *p_a1,
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel3_plus_4_b(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel3_plus_4_b * 1 * 1 +
                n_z * xdim0_update_halo_kernel3_plus_4_b *
                    ydim0_update_halo_kernel3_plus_4_b * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel3_plus_4_b * 1 * 1 +
