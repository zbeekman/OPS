...
void update_halo_kernel5_minus_2_back_c_wrapper(double *p_a0, double *p_a1,
                                                int p_a2, int x_size,
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel5_minus_2_back(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel5_minus_2_back * 1 * 1 +
                n_z * xdim0_update_halo_kernel5_minus_2_back *
                    ydim0_update_halo_kernel5_minus_2_back * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel5_minus_2_back * 1 * 1 +
