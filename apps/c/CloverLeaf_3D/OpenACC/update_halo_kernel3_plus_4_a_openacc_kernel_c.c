...
void update_halo_kernel3_plus_4_a_c_wrapper(double *p_a0, double *p_a1,
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel3_plus_4_a(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel3_plus_4_a * 1 * 1 +
                n_z * xdim0_update_halo_kernel3_plus_4_a *
                    ydim0_update_halo_kernel3_plus_4_a * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel3_plus_4_a * 1 * 1 +
