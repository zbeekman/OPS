...
inline void update_halo_kernel2_xvel_plus_4_front(double *xvel0, double *xvel1,
                                                  const int *fields) {
...
void update_halo_kernel2_xvel_plus_4_front_c_wrapper(double *p_a0, double *p_a1,
                                                     int p_a2, int x_size,
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel2_xvel_plus_4_front(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel2_xvel_plus_4_front * 1 * 1 +
                n_z * xdim0_update_halo_kernel2_xvel_plus_4_front *
                    ydim0_update_halo_kernel2_xvel_plus_4_front * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel2_xvel_plus_4_front * 1 * 1 +
