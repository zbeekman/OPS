  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        update_halo_kernel1_r1(  p_a0 + n_x*1*1 + n_y*xdim0_update_halo_kernel1_r1*1*1 + n_z*xdim0_update_halo_kernel1_r1*ydim0_update_halo_kernel1_r1*1,
           p_a1 + n_x*1*1 + n_y*xdim1_update_halo_kernel1_r1*1*1 + n_z*xdim1_update_halo_kernel1_r1*ydim1_update_halo_kernel1_r1*1,
           p_a2 + n_x*1*1 + n_y*xdim2_update_halo_kernel1_r1*1*1 + n_z*xdim2_update_halo_kernel1_r1*ydim2_update_halo_kernel1_r1*1,
           p_a3 + n_x*1*1 + n_y*xdim3_update_halo_kernel1_r1*1*1 + n_z*xdim3_update_halo_kernel1_r1*ydim3_update_halo_kernel1_r1*1,
           p_a4 + n_x*1*1 + n_y*xdim4_update_halo_kernel1_r1*1*1 + n_z*xdim4_update_halo_kernel1_r1*ydim4_update_halo_kernel1_r1*1,
           p_a5 + n_x*1*1 + n_y*xdim5_update_halo_kernel1_r1*1*1 + n_z*xdim5_update_halo_kernel1_r1*ydim5_update_halo_kernel1_r1*1,
           p_a6 + n_x*1*1 + n_y*xdim6_update_halo_kernel1_r1*1*1 + n_z*xdim6_update_halo_kernel1_r1*ydim6_update_halo_kernel1_r1*1,
           &p_a7 );
