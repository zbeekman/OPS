...
inline void update_halo_kernel2_zvel_plus_2_right(double *zvel0, double *zvel1,
                                                  const int *fields) {
...
void update_halo_kernel2_zvel_plus_2_right_c_wrapper(double *p_a0, double *p_a1,
                                                     int p_a2, int x_size,
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel2_zvel_plus_2_right(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel2_zvel_plus_2_right * 1 * 1 +
                n_z * xdim0_update_halo_kernel2_zvel_plus_2_right *
                    ydim0_update_halo_kernel2_zvel_plus_2_right * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel2_zvel_plus_2_right * 1 * 1 +
