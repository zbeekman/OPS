...
inline void update_halo_kernel3_plus_2_front(double *vol_flux_x,
                                             double *mass_flux_x,
                                             const int *fields) {
...
#pragma acc loop
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        update_halo_kernel3_plus_2_front(
            p_a0 + n_x * 1 * 1 +
                n_y * xdim0_update_halo_kernel3_plus_2_front * 1 * 1 +
                n_z * xdim0_update_halo_kernel3_plus_2_front *
                    ydim0_update_halo_kernel3_plus_2_front * 1,
            p_a1 + n_x * 1 * 1 +
                n_y * xdim1_update_halo_kernel3_plus_2_front * 1 * 1 +
