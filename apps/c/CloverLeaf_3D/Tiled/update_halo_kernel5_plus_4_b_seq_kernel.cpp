...
// host stub function
void ops_par_loop_update_halo_kernel5_plus_4_b_execute(
  ...
  int xdim0_update_halo_kernel5_plus_4_b = args[0].dat->size[0];
  int ydim0_update_halo_kernel5_plus_4_b = args[0].dat->size[1];
  int xdim1_update_halo_kernel5_plus_4_b = args[1].dat->size[0];
  int ydim1_update_halo_kernel5_plus_4_b = args[1].dat->size[1];
