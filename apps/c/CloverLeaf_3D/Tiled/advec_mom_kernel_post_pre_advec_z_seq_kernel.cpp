...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_advec_mom_kernel_post_pre_advec_z*1+n_z*xdim0_advec_mom_kernel_post_pre_advec_z*ydim0_advec_mom_kernel_post_pre_advec_z*1+x+xdim0_advec_mom_kernel_post_pre_advec_z*(y)+xdim0_advec_mom_kernel_post_pre_advec_z*ydim0_advec_mom_kernel_post_pre_advec_z*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_advec_mom_kernel_post_pre_advec_z*1+n_z*xdim1_advec_mom_kernel_post_pre_advec_z*ydim1_advec_mom_kernel_post_pre_advec_z*1+x+xdim1_advec_mom_kernel_post_pre_advec_z*(y)+xdim1_advec_mom_kernel_post_pre_advec_z*ydim1_advec_mom_kernel_post_pre_advec_z*(z))
#define OPS_ACC2(x,y,z) (n_x*1+n_y*xdim2_advec_mom_kernel_post_pre_advec_z*1+n_z*xdim2_advec_mom_kernel_post_pre_advec_z*ydim2_advec_mom_kernel_post_pre_advec_z*1+x+xdim2_advec_mom_kernel_post_pre_advec_z*(y)+xdim2_advec_mom_kernel_post_pre_advec_z*ydim2_advec_mom_kernel_post_pre_advec_z*(z))
#define OPS_ACC3(x,y,z) (n_x*1+n_y*xdim3_advec_mom_kernel_post_pre_advec_z*1+n_z*xdim3_advec_mom_kernel_post_pre_advec_z*ydim3_advec_mom_kernel_post_pre_advec_z*1+x+xdim3_advec_mom_kernel_post_pre_advec_z*(y)+xdim3_advec_mom_kernel_post_pre_advec_z*ydim3_advec_mom_kernel_post_pre_advec_z*(z))
#define OPS_ACC4(x,y,z) (n_x*1+n_y*xdim4_advec_mom_kernel_post_pre_advec_z*1+n_z*xdim4_advec_mom_kernel_post_pre_advec_z*ydim4_advec_mom_kernel_post_pre_advec_z*1+x+xdim4_advec_mom_kernel_post_pre_advec_z*(y)+xdim4_advec_mom_kernel_post_pre_advec_z*ydim4_advec_mom_kernel_post_pre_advec_z*(z))
