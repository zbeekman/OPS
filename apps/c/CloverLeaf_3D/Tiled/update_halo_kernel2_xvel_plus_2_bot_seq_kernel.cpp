...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_bot_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_update_halo_kernel2_xvel_plus_2_bot = args[0].dat->size[0];
  int ydim0_update_halo_kernel2_xvel_plus_2_bot = args[0].dat->size[1];
  int xdim1_update_halo_kernel2_xvel_plus_2_bot = args[1].dat->size[0];
  int ydim1_update_halo_kernel2_xvel_plus_2_bot = args[1].dat->size[1];
