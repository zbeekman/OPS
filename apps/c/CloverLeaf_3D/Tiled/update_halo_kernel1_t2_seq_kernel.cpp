...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim5_update_halo_kernel1_t2 * 1 +                          \
...
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim6_update_halo_kernel1_t2 * 1 +                          \
