...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_advec_mom_kernel2_x*1+n_z*xdim0_advec_mom_kernel2_x*ydim0_advec_mom_kernel2_x*1+x+xdim0_advec_mom_kernel2_x*(y)+xdim0_advec_mom_kernel2_x*ydim0_advec_mom_kernel2_x*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_advec_mom_kernel2_x*1+n_z*xdim1_advec_mom_kernel2_x*ydim1_advec_mom_kernel2_x*1+x+xdim1_advec_mom_kernel2_x*(y)+xdim1_advec_mom_kernel2_x*ydim1_advec_mom_kernel2_x*(z))
#define OPS_ACC2(x,y,z) (n_x*1+n_y*xdim2_advec_mom_kernel2_x*1+n_z*xdim2_advec_mom_kernel2_x*ydim2_advec_mom_kernel2_x*1+x+xdim2_advec_mom_kernel2_x*(y)+xdim2_advec_mom_kernel2_x*ydim2_advec_mom_kernel2_x*(z))
#define OPS_ACC3(x,y,z) (n_x*1+n_y*xdim3_advec_mom_kernel2_x*1+n_z*xdim3_advec_mom_kernel2_x*ydim3_advec_mom_kernel2_x*1+x+xdim3_advec_mom_kernel2_x*(y)+xdim3_advec_mom_kernel2_x*ydim3_advec_mom_kernel2_x*(z))
