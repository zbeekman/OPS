...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_update_halo_kernel5_minus_2_back*1+n_z*xdim0_update_halo_kernel5_minus_2_back*ydim0_update_halo_kernel5_minus_2_back*1+x+xdim0_update_halo_kernel5_minus_2_back*(y)+xdim0_update_halo_kernel5_minus_2_back*ydim0_update_halo_kernel5_minus_2_back*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_update_halo_kernel5_minus_2_back*1+n_z*xdim1_update_halo_kernel5_minus_2_back*ydim1_update_halo_kernel5_minus_2_back*1+x+xdim1_update_halo_kernel5_minus_2_back*(y)+xdim1_update_halo_kernel5_minus_2_back*ydim1_update_halo_kernel5_minus_2_back*(z))
