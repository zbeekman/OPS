...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel2_zvel_plus_4_right * 1 +           \
   n_z * xdim0_update_halo_kernel2_zvel_plus_4_right *                         \
       ydim0_update_halo_kernel2_zvel_plus_4_right * 1 +                       \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel2_zvel_plus_4_right * 1 +           \
   n_z * xdim1_update_halo_kernel2_zvel_plus_4_right *                         \
       ydim1_update_halo_kernel2_zvel_plus_4_right * 1 +                       \
