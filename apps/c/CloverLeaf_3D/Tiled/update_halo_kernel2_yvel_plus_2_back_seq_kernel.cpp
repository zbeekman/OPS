...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_update_halo_kernel2_yvel_plus_2_back*1+n_z*xdim0_update_halo_kernel2_yvel_plus_2_back*ydim0_update_halo_kernel2_yvel_plus_2_back*1+x+xdim0_update_halo_kernel2_yvel_plus_2_back*(y)+xdim0_update_halo_kernel2_yvel_plus_2_back*ydim0_update_halo_kernel2_yvel_plus_2_back*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_update_halo_kernel2_yvel_plus_2_back*1+n_z*xdim1_update_halo_kernel2_yvel_plus_2_back*ydim1_update_halo_kernel2_yvel_plus_2_back*1+x+xdim1_update_halo_kernel2_yvel_plus_2_back*(y)+xdim1_update_halo_kernel2_yvel_plus_2_back*ydim1_update_halo_kernel2_yvel_plus_2_back*(z))
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_back_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_update_halo_kernel2_yvel_plus_2_back = args[0].dat->size[0];
  int ydim0_update_halo_kernel2_yvel_plus_2_back = args[0].dat->size[1];
  int xdim1_update_halo_kernel2_yvel_plus_2_back = args[1].dat->size[0];
  int ydim1_update_halo_kernel2_yvel_plus_2_back = args[1].dat->size[1];
