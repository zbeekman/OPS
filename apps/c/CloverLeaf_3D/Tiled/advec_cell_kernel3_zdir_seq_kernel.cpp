...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_advec_cell_kernel3_zdir*1+n_z*xdim0_advec_cell_kernel3_zdir*ydim0_advec_cell_kernel3_zdir*1+x+xdim0_advec_cell_kernel3_zdir*(y)+xdim0_advec_cell_kernel3_zdir*ydim0_advec_cell_kernel3_zdir*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_advec_cell_kernel3_zdir*1+n_z*xdim1_advec_cell_kernel3_zdir*ydim1_advec_cell_kernel3_zdir*1+x+xdim1_advec_cell_kernel3_zdir*(y)+xdim1_advec_cell_kernel3_zdir*ydim1_advec_cell_kernel3_zdir*(z))
#define OPS_ACC2(x,y,z) (n_x*0+n_y*xdim2_advec_cell_kernel3_zdir*0+n_z*xdim2_advec_cell_kernel3_zdir*ydim2_advec_cell_kernel3_zdir*1+x+xdim2_advec_cell_kernel3_zdir*(y)+xdim2_advec_cell_kernel3_zdir*ydim2_advec_cell_kernel3_zdir*(z))
#define OPS_ACC3(x,y,z) (n_x*0+n_y*xdim3_advec_cell_kernel3_zdir*0+n_z*xdim3_advec_cell_kernel3_zdir*ydim3_advec_cell_kernel3_zdir*1+x+xdim3_advec_cell_kernel3_zdir*(y)+xdim3_advec_cell_kernel3_zdir*ydim3_advec_cell_kernel3_zdir*(z))
#define OPS_ACC4(x,y,z) (n_x*1+n_y*xdim4_advec_cell_kernel3_zdir*1+n_z*xdim4_advec_cell_kernel3_zdir*ydim4_advec_cell_kernel3_zdir*1+x+xdim4_advec_cell_kernel3_zdir*(y)+xdim4_advec_cell_kernel3_zdir*ydim4_advec_cell_kernel3_zdir*(z))
#define OPS_ACC5(x,y,z) (n_x*1+n_y*xdim5_advec_cell_kernel3_zdir*1+n_z*xdim5_advec_cell_kernel3_zdir*ydim5_advec_cell_kernel3_zdir*1+x+xdim5_advec_cell_kernel3_zdir*(y)+xdim5_advec_cell_kernel3_zdir*ydim5_advec_cell_kernel3_zdir*(z))
#define OPS_ACC6(x,y,z) (n_x*1+n_y*xdim6_advec_cell_kernel3_zdir*1+n_z*xdim6_advec_cell_kernel3_zdir*ydim6_advec_cell_kernel3_zdir*1+x+xdim6_advec_cell_kernel3_zdir*(y)+xdim6_advec_cell_kernel3_zdir*ydim6_advec_cell_kernel3_zdir*(z))
#define OPS_ACC7(x,y,z) (n_x*1+n_y*xdim7_advec_cell_kernel3_zdir*1+n_z*xdim7_advec_cell_kernel3_zdir*ydim7_advec_cell_kernel3_zdir*1+x+xdim7_advec_cell_kernel3_zdir*(y)+xdim7_advec_cell_kernel3_zdir*ydim7_advec_cell_kernel3_zdir*(z))
...
void ops_par_loop_advec_cell_kernel3_zdir_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      #pragma omp simd aligned(vol_flux_z,pre_vol,zz,vertexdz,density1,energy1,mass_flux_z,ener_flux)
      #else
      #pragma simd
      #endif
