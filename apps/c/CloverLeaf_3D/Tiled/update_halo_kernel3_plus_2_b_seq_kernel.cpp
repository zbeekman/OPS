...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_update_halo_kernel3_plus_2_b*1+n_z*xdim0_update_halo_kernel3_plus_2_b*ydim0_update_halo_kernel3_plus_2_b*1+x+xdim0_update_halo_kernel3_plus_2_b*(y)+xdim0_update_halo_kernel3_plus_2_b*ydim0_update_halo_kernel3_plus_2_b*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_update_halo_kernel3_plus_2_b*1+n_z*xdim1_update_halo_kernel3_plus_2_b*ydim1_update_halo_kernel3_plus_2_b*1+x+xdim1_update_halo_kernel3_plus_2_b*(y)+xdim1_update_halo_kernel3_plus_2_b*ydim1_update_halo_kernel3_plus_2_b*(z))
...
void ops_par_loop_update_halo_kernel3_plus_2_b_execute(ops_kernel_descriptor *desc) {
  ...
  int ydim0_update_halo_kernel3_plus_2_b = args[0].dat->size[1];
  int xdim1_update_halo_kernel3_plus_2_b = args[1].dat->size[0];
  int ydim1_update_halo_kernel3_plus_2_b = args[1].dat->size[1];
