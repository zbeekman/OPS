...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_advec_mom_kernel1_z_nonvector*1+n_z*xdim0_advec_mom_kernel1_z_nonvector*ydim0_advec_mom_kernel1_z_nonvector*1+x+xdim0_advec_mom_kernel1_z_nonvector*(y)+xdim0_advec_mom_kernel1_z_nonvector*ydim0_advec_mom_kernel1_z_nonvector*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_advec_mom_kernel1_z_nonvector*1+n_z*xdim1_advec_mom_kernel1_z_nonvector*ydim1_advec_mom_kernel1_z_nonvector*1+x+xdim1_advec_mom_kernel1_z_nonvector*(y)+xdim1_advec_mom_kernel1_z_nonvector*ydim1_advec_mom_kernel1_z_nonvector*(z))
#define OPS_ACC2(x,y,z) (n_x*1+n_y*xdim2_advec_mom_kernel1_z_nonvector*1+n_z*xdim2_advec_mom_kernel1_z_nonvector*ydim2_advec_mom_kernel1_z_nonvector*1+x+xdim2_advec_mom_kernel1_z_nonvector*(y)+xdim2_advec_mom_kernel1_z_nonvector*ydim2_advec_mom_kernel1_z_nonvector*(z))
#define OPS_ACC3(x,y,z) (n_x*0+n_y*xdim3_advec_mom_kernel1_z_nonvector*0+n_z*xdim3_advec_mom_kernel1_z_nonvector*ydim3_advec_mom_kernel1_z_nonvector*1+x+xdim3_advec_mom_kernel1_z_nonvector*(y)+xdim3_advec_mom_kernel1_z_nonvector*ydim3_advec_mom_kernel1_z_nonvector*(z))
#define OPS_ACC4(x,y,z) (n_x*1+n_y*xdim4_advec_mom_kernel1_z_nonvector*1+n_z*xdim4_advec_mom_kernel1_z_nonvector*ydim4_advec_mom_kernel1_z_nonvector*1+x+xdim4_advec_mom_kernel1_z_nonvector*(y)+xdim4_advec_mom_kernel1_z_nonvector*ydim4_advec_mom_kernel1_z_nonvector*(z))
