...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_update_halo_kernel2_xvel_plus_4_front*1+n_z*xdim0_update_halo_kernel2_xvel_plus_4_front*ydim0_update_halo_kernel2_xvel_plus_4_front*1+x+xdim0_update_halo_kernel2_xvel_plus_4_front*(y)+xdim0_update_halo_kernel2_xvel_plus_4_front*ydim0_update_halo_kernel2_xvel_plus_4_front*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_update_halo_kernel2_xvel_plus_4_front*1+n_z*xdim1_update_halo_kernel2_xvel_plus_4_front*ydim1_update_halo_kernel2_xvel_plus_4_front*1+x+xdim1_update_halo_kernel2_xvel_plus_4_front*(y)+xdim1_update_halo_kernel2_xvel_plus_4_front*ydim1_update_halo_kernel2_xvel_plus_4_front*(z))
