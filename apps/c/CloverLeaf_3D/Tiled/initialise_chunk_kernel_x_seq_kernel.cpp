...
void ops_par_loop_initialise_chunk_kernel_x_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ vertexx = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const int * __restrict__ xx = (int *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ vertexdx = (double *)(args[2].data + base2);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      #pragma omp simd aligned(vertexx,xx,vertexdx)
      #else
      #pragma simd
      #endif
