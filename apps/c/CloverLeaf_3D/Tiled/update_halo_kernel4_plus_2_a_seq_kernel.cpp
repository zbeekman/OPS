...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel4_plus_2_a * 1 +                    \
   n_z * xdim0_update_halo_kernel4_plus_2_a *                                  \
       ydim0_update_halo_kernel4_plus_2_a * 1 +                                \
   x + xdim0_update_halo_kernel4_plus_2_a * (y) +                              \
   xdim0_update_halo_kernel4_plus_2_a * ydim0_update_halo_kernel4_plus_2_a *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel4_plus_2_a * 1 +                    \
   n_z * xdim1_update_halo_kernel4_plus_2_a *                                  \
       ydim1_update_halo_kernel4_plus_2_a * 1 +                                \
...
// host stub function
void ops_par_loop_update_halo_kernel4_plus_2_a_execute(
  ...
  int xdim0_update_halo_kernel4_plus_2_a = args[0].dat->size[0];
  int ydim0_update_halo_kernel4_plus_2_a = args[0].dat->size[1];
  int xdim1_update_halo_kernel4_plus_2_a = args[1].dat->size[0];
  int ydim1_update_halo_kernel4_plus_2_a = args[1].dat->size[1];
