...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel3_plus_4_a * 1 +                    \
   n_z * xdim0_update_halo_kernel3_plus_4_a *                                  \
       ydim0_update_halo_kernel3_plus_4_a * 1 +                                \
   x + xdim0_update_halo_kernel3_plus_4_a * (y) +                              \
   xdim0_update_halo_kernel3_plus_4_a * ydim0_update_halo_kernel3_plus_4_a *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel3_plus_4_a * 1 +                    \
   n_z * xdim1_update_halo_kernel3_plus_4_a *                                  \
       ydim1_update_halo_kernel3_plus_4_a * 1 +                                \
...
// host stub function
void ops_par_loop_update_halo_kernel3_plus_4_a_execute(
