...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_update_halo_kernel5_plus_4_right * 1 +                \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_update_halo_kernel5_plus_4_right * 1 +                \
...
void ops_par_loop_update_halo_kernel5_plus_4_right_execute(
  ...
  int xdim0_update_halo_kernel5_plus_4_right = args[0].dat->size[0];
  int ydim0_update_halo_kernel5_plus_4_right = args[0].dat->size[1];
  int xdim1_update_halo_kernel5_plus_4_right = args[1].dat->size[0];
  int ydim1_update_halo_kernel5_plus_4_right = args[1].dat->size[1];
