...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_advec_mom_kernel_z3*1+n_z*xdim0_advec_mom_kernel_z3*ydim0_advec_mom_kernel_z3*1+x+xdim0_advec_mom_kernel_z3*(y)+xdim0_advec_mom_kernel_z3*ydim0_advec_mom_kernel_z3*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_advec_mom_kernel_z3*1+n_z*xdim1_advec_mom_kernel_z3*ydim1_advec_mom_kernel_z3*1+x+xdim1_advec_mom_kernel_z3*(y)+xdim1_advec_mom_kernel_z3*ydim1_advec_mom_kernel_z3*(z))
#define OPS_ACC2(x,y,z) (n_x*1+n_y*xdim2_advec_mom_kernel_z3*1+n_z*xdim2_advec_mom_kernel_z3*ydim2_advec_mom_kernel_z3*1+x+xdim2_advec_mom_kernel_z3*(y)+xdim2_advec_mom_kernel_z3*ydim2_advec_mom_kernel_z3*(z))
#define OPS_ACC3(x,y,z) (n_x*1+n_y*xdim3_advec_mom_kernel_z3*1+n_z*xdim3_advec_mom_kernel_z3*ydim3_advec_mom_kernel_z3*1+x+xdim3_advec_mom_kernel_z3*(y)+xdim3_advec_mom_kernel_z3*ydim3_advec_mom_kernel_z3*(z))
...
void ops_par_loop_advec_mom_kernel_z3_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      #pragma omp simd aligned(pre_vol,post_vol,volume,vol_flux_z)
      #else
      #pragma simd
      #endif
