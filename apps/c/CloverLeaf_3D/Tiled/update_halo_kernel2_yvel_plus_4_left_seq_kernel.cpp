...
//
#define OPS_ACC0(x,y,z) (n_x*1+n_y*xdim0_update_halo_kernel2_yvel_plus_4_left*1+n_z*xdim0_update_halo_kernel2_yvel_plus_4_left*ydim0_update_halo_kernel2_yvel_plus_4_left*1+x+xdim0_update_halo_kernel2_yvel_plus_4_left*(y)+xdim0_update_halo_kernel2_yvel_plus_4_left*ydim0_update_halo_kernel2_yvel_plus_4_left*(z))
#define OPS_ACC1(x,y,z) (n_x*1+n_y*xdim1_update_halo_kernel2_yvel_plus_4_left*1+n_z*xdim1_update_halo_kernel2_yvel_plus_4_left*ydim1_update_halo_kernel2_yvel_plus_4_left*1+x+xdim1_update_halo_kernel2_yvel_plus_4_left*(y)+xdim1_update_halo_kernel2_yvel_plus_4_left*ydim1_update_halo_kernel2_yvel_plus_4_left*(z))
...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_left_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_update_halo_kernel2_yvel_plus_4_left = args[0].dat->size[0];
  int ydim0_update_halo_kernel2_yvel_plus_4_left = args[0].dat->size[1];
  ...
  if((*fields) & FIELD_YVEL0) yvel0[OPS_ACC0(0,0,0)] = yvel0[OPS_ACC0(4,0,0)];
  if((*fields) & FIELD_YVEL1) yvel1[OPS_ACC1(0,0,0)] = yvel1[OPS_ACC1(4,0,0)];
